// Vllm plugin entrypoint registers its EVE integration.
import {
  definePluginEntry,
  type EVEPluginApi,
...
async function loadProviderSetup() {
  return await import("eve-agent/plugin-sdk/provider-setup");
}
  ...
  register(api: EVEPluginApi) {
    api.registerProvider({
      ...
      buildUnknownModelHint: () =>
        ...
        'Set VLLM_API_KEY (any value works) or run "eve configure". ' +
        "See: https://docs.eve.ai/providers/vllm",
