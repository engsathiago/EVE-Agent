// Lobster plugin entrypoint registers its EVE integration.
import { definePluginEntry } from "eve-agent/plugin-sdk/plugin-entry";
import type { AnyAgentTool, EVEPluginApi, EVEPluginToolFactory } from "./runtime-api.js";
