...
import { appendRegularFile, pathExists } from "eve-agent/plugin-sdk/security-runtime";
import { isRecord as sharedIsRecord } from "eve-agent/plugin-sdk/string-coerce-runtime";
