...
import { VERSION } from "eve-agent/plugin-sdk/cli-runtime";
import {
...
import { getChildLogger, toPinoLikeLogger } from "eve-agent/plugin-sdk/runtime-env";
