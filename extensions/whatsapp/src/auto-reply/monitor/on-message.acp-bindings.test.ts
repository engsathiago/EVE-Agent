...
import type { ConfiguredBindingRouteResult } from "eve-agent/plugin-sdk/conversation-binding-runtime";
...
vi.mock("eve-agent/plugin-sdk/conversation-binding-runtime", () => ({
...
vi.mock("eve-agent/plugin-sdk/routing", async (importOriginal) => {
  const actual = await importOriginal<typeof import("eve-agent/plugin-sdk/routing")>();
  return {
    ...actual,
