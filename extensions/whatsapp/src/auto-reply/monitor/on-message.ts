...
import type { AckReactionHandle } from "eve-agent/plugin-sdk/channel-feedback";
import type { EVEConfig } from "eve-agent/plugin-sdk/config-contracts";
import {
  ensureConfiguredBindingRouteReady,
  resolveConfiguredBindingRoute,
} from "eve-agent/plugin-sdk/conversation-binding-runtime";
import type { getReplyFromConfig } from "eve-agent/plugin-sdk/reply-runtime";
import type { MsgContext } from "eve-agent/plugin-sdk/reply-runtime";
import { resolveAgentRoute } from "eve-agent/plugin-sdk/routing";
import { buildGroupHistoryKey } from "eve-agent/plugin-sdk/routing";
...
export function createWebOnMessageHandler(params: {
  ...
  replyLogger: ReturnType<(typeof import("eve-agent/plugin-sdk/runtime-env"))["getChildLogger"]>;
