...
export const legacyConfigRules: LegacyConfigRule[] = [
  {
    ...
    message:
      'models.providers.ollama-cloud.baseUrl="https://ai.ollama.com" is retired; use "https://ollama.com". Run "eve doctor --fix".',
    match: (value) => findRetiredOllamaCloudBaseUrl(value) !== null,
  },
];

export function migrateOllamaCloudRetiredBaseUrl(config: EVEConfig): {
  config: EVEConfig;
  changes: string[];
} | null {
  ...
  nextConfig.models = nextModels as EVEConfig["models"];
