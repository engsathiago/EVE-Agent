...
function resolveConfiguredOllamaWebSearchApiKey(config?: EVEConfig): string | undefined {
...
function resolveOllamaWebSearchApiKey(config?: EVEConfig): string | undefined {
  return resolveConfiguredOllamaWebSearchApiKey(config) ?? resolveEnvOllamaWebSearchApiKey();
}

function resolveOllamaWebSearchBaseUrl(config?: EVEConfig): string {
