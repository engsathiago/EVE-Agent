...
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "eve-agent/plugin-sdk/routing";
...
const FEISHU_THREAD_BINDINGS_STATE_KEY = Symbol.for("eve.feishuThreadBindingsState");
