...
function mergeZalouserAccountConfig(cfg: EVEConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: EVEConfig; accountId?: string | null }) {
