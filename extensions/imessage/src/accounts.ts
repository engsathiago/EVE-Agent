...
function mergeIMessageAccountConfig(cfg: EVEConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: EVEConfig): ResolvedIMessageAccount[] {
