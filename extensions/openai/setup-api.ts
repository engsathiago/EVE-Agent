...
import type { ProviderAuthContext, ProviderAuthResult } from "eve-agent/plugin-sdk/plugin-entry";
import type { ProviderAuthMethod } from "eve-agent/plugin-sdk/plugin-entry";
