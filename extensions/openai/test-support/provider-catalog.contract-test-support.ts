...
import type { ProviderPlugin } from "eve-agent/plugin-sdk/provider-test-contracts";
...
vi.mock("eve-agent/plugin-sdk/provider-catalog-runtime", async () => {
  const actual = await vi.importActual<
    typeof import("eve-agent/plugin-sdk/provider-catalog-runtime")
  >("eve-agent/plugin-sdk/provider-catalog-runtime");
