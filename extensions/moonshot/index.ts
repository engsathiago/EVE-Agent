// Moonshot plugin entrypoint registers its EVE integration.
import { defineSingleProviderPluginEntry } from "eve-agent/plugin-sdk/provider-entry";
import { buildOpenAICompatibleReplayPolicy } from "eve-agent/plugin-sdk/provider-model-shared";
import { MOONSHOT_THINKING_STREAM_HOOKS } from "eve-agent/plugin-sdk/provider-stream-family";
