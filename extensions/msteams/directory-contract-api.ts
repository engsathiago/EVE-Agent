...
import type { ChannelDirectoryAdapter } from "eve-agent/plugin-sdk/channel-contract";
import { listDirectoryEntriesFromSources } from "eve-agent/plugin-sdk/directory-runtime";
