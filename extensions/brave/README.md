...
Official Brave Search provider plugin for EVE.
...
```bash
eve plugins install @eve/brave-plugin
```
...
```bash
eve config set plugins.entries.brave.enabled true
eve config set tools.web.search.provider brave
```
