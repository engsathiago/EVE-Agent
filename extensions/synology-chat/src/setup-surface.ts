...
function getChannelConfig(cfg: EVEConfig): SynologyChatChannelConfig {
  return (cfg.channels?.[channel] as SynologyChatChannelConfig | undefined) ?? {};
}

function getRawAccountConfig(cfg: EVEConfig, accountId: string): SynologyChatAccountRaw {
...
function isSynologyChatConfigured(cfg: EVEConfig, accountId: string): boolean {
...
function resolveExistingAllowedUserIds(cfg: EVEConfig, accountId: string): string[] {
