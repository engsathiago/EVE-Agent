...
import type { OutputRuntimeEnv } from "eve-agent/plugin-sdk/runtime";
import type { ChannelSetupWizardAdapter } from "eve-agent/plugin-sdk/setup";
...
export function createMatrixUpdateKeepCredentialsPrompter(params?: {
  ...
  return createMatrixWizardPrompter({
    ...
    text: {
      ...
      "Matrix device name (optional)": params?.deviceName ?? "EVE Gateway",
    },
    confirm: {
