...
import { hasConfiguredSecretInput } from "eve-agent/plugin-sdk/secret-input-runtime";
...
export function resolveMatrixChannelConfig(cfg: EVEConfig): Record<string, unknown> | null {
