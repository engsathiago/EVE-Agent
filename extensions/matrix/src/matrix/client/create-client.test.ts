...
describe("createMatrixClient", () => {
  const storagePaths = {
    rootDir: "/tmp/eve-matrix-create-client-test",
    storagePath: "/tmp/eve-matrix-create-client-test/storage.json",
    recoveryKeyPath: "/tmp/eve-matrix-create-client-test/recovery.key",
    idbSnapshotPath: "/tmp/eve-matrix-create-client-test/idb.snapshot",
    accountKey: "default",
  ...
  it("persists storage metadata by default", async () => {
    ...
    expect(MatrixClientMock).toHaveBeenCalledWith("https://matrix.example.org", "tok", {
      ...
      cryptoDatabasePrefix: "eve-matrix-default-token-hash",
