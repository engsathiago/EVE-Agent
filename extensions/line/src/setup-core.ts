...
import type { ChannelSetupAdapter, EVEConfig } from "eve-agent/plugin-sdk/setup";
import { createSetupInputPresenceValidator } from "eve-agent/plugin-sdk/setup";
...
export function isLineConfigured(cfg: EVEConfig, accountId: string): boolean {
