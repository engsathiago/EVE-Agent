...
vi.mock("eve-agent/plugin-sdk/channel-inbound", () => ({
  buildMentionRegexes: () => [],
  matchesMentionPatterns: () => false,
}));
vi.mock("eve-agent/plugin-sdk/channel-pairing", () => ({
...
vi.mock("eve-agent/plugin-sdk/command-auth-native", () => ({
...
vi.mock("eve-agent/plugin-sdk/runtime-group-policy", () => ({
...
vi.mock("eve-agent/plugin-sdk/routing", () => ({
...
describe("handleLineWebhookEvents", () => {
  ...
  afterAll(() => {
    vi.doUnmock("eve-agent/plugin-sdk/channel-inbound");
    vi.doUnmock("eve-agent/plugin-sdk/channel-pairing");
    vi.doUnmock("eve-agent/plugin-sdk/command-auth-native");
    vi.doUnmock("eve-agent/plugin-sdk/runtime-group-policy");
    vi.doUnmock("eve-agent/plugin-sdk/runtime-env");
    vi.doUnmock("eve-agent/plugin-sdk/reply-history");
    vi.doUnmock("eve-agent/plugin-sdk/routing");
