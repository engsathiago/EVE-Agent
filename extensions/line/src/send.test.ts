...
vi.mock("eve-agent/plugin-sdk/plugin-config-runtime", () => ({
...
vi.mock("eve-agent/plugin-sdk/channel-activity-runtime", () => ({
...
describe("LINE send helpers", () => {
  ...
  afterAll(() => {
    ...
    vi.doUnmock("eve-agent/plugin-sdk/channel-activity-runtime");
