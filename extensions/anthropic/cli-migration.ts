...
type AgentDefaultsModel = NonNullable<NonNullable<EVEConfig["agents"]>["defaults"]>["model"];
type AgentDefaultsModels = NonNullable<NonNullable<EVEConfig["agents"]>["defaults"]>["models"];
