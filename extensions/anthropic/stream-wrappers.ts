...
const EVE_DEFAULT_ANTHROPIC_BETAS = [
  "fine-grained-tool-streaming-2025-05-14",
  "interleaved-thinking-2025-05-14",
] as const;
const EVE_OAUTH_ANTHROPIC_BETAS = [
  "claude-code-20250219",
  "oauth-2025-04-20",
  ...EVE_DEFAULT_ANTHROPIC_BETAS,
] as const;
...
/** Wrap a stream function to merge EVE and configured Anthropic beta headers. */
export function createAnthropicBetaHeadersWrapper(
  ...
  return (model, context, options) => {
    ...
    const eveBetas = isOauth
      ? (EVE_OAUTH_ANTHROPIC_BETAS as readonly string[])
      : (EVE_DEFAULT_ANTHROPIC_BETAS as readonly string[]);
    const allBetas = [...new Set([...eveBetas, ...effectiveBetas])];
