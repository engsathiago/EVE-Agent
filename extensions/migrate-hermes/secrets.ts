...
import { updateAuthProfileStoreWithLock } from "eve-agent/plugin-sdk/provider-auth";
import {
...
async function buildOpenCodeSecretCandidates(
  ...
  // EVE's Copilot token profile cannot preserve OpenCode enterprise routing yet.
