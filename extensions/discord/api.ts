...
// Deprecated compatibility surface for existing @eve/discord/api.js consumers.
...
export { resolveOpenProviderRuntimeGroupPolicy as resolveDiscordRuntimeGroupPolicy } from "eve-agent/plugin-sdk/runtime-group-policy";
