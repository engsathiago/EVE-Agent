...
import { createSubsystemLogger, formatDurationSeconds } from "eve-agent/plugin-sdk/runtime-env";

export type DiscordListenerLogger = ReturnType<
  typeof import("eve-agent/plugin-sdk/runtime-env").createSubsystemLogger
>;
