...
import type { EVEConfig, TtsConfig } from "eve-agent/plugin-sdk/config-contracts";
import { parseTtsDirectives } from "eve-agent/plugin-sdk/speech";
...
function resolveVoiceTtsConfig(params: { cfg: EVEConfig; override?: TtsConfig }): {
  cfg: EVEConfig;
