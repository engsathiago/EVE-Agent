...
import { buildMessagingTarget, type MessagingTarget } from "eve-agent/plugin-sdk/channel-targets";
import type { DirectoryConfigParams } from "eve-agent/plugin-sdk/directory-runtime";
