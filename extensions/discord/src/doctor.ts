...
import { collectProviderDangerousNameMatchingScopes } from "eve-agent/plugin-sdk/runtime-doctor";
...
export function scanDiscordNumericIdEntries(cfg: EVEConfig): DiscordNumericIdHit[] {
...
export function maybeRepairDiscordNumericIds(
  cfg: EVEConfig,
  doctorFixCommand: string,
): { config: EVEConfig; changes: string[]; warnings?: string[] } {
...
function collectDiscordMutableAllowlistWarnings(cfg: EVEConfig): string[] {
