...
import { buildPluginConfigSchema, type EVEPluginConfigSchema } from "eve-agent/plugin-sdk/core";
import {
  formatPluginConfigIssue,
  mapPluginConfigIssues,
} from "eve-agent/plugin-sdk/extension-shared";
import { MAX_TIMER_TIMEOUT_SECONDS } from "eve-agent/plugin-sdk/number-runtime";
import { z } from "zod";
...
export function createOpenShellPluginConfigSchema(): EVEPluginConfigSchema {
