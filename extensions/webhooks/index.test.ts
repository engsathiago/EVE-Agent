...
function createApi(params?: {
  pluginConfig?: EVEPluginApi["pluginConfig"];
  registerHttpRoute?: EVEPluginApi["registerHttpRoute"];
  logger?: EVEPluginApi["logger"];
}): EVEPluginApi {
...
function requireFirstRouteRegistration(mock: ReturnType<typeof vi.fn>) {
  ...
  return call[0] as Parameters<EVEPluginApi["registerHttpRoute"]>[0];
}
