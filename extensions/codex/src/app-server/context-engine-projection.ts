/**
 * Projects EVE context-engine assemblies into Codex prompt text while
...
const CONTEXT_HEADER = "EVE assembled context for this turn:";
...
/** Projects assembled EVE context-engine messages into Codex prompt inputs. */
