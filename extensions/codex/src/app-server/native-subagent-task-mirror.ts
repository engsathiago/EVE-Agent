/**
 * Mirrors Codex native subagent thread lifecycle events into EVE task
 * runtime rows so parent sessions can observe child progress.
 */
import type { AgentHarnessTaskRuntime } from "eve-agent/plugin-sdk/agent-harness-task-runtime";
...
/** Converts a Codex child thread id into the EVE task-runtime run id. */
