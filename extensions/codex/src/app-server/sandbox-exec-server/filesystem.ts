 ...
 * with EVE sandbox policy checks before every bridge operation.
 */
import { posix as pathPosix } from "node:path";
import type { SandboxFsStat } from "eve-agent/plugin-sdk/sandbox";
...
import type { DirectoryEntry, EVEExecServer, ResolvedFsSandboxPolicy } from "./types.js";
