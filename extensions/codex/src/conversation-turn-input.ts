...
import type { PluginHookInboundClaimEvent } from "eve-agent/plugin-sdk/plugin-entry";
import { normalizeSingleOrTrimmedStringList } from "eve-agent/plugin-sdk/string-coerce-runtime";
...
function extractInboundMedia(event: PluginHookInboundClaimEvent): InboundMedia[] {
  ...
  // EVE channels expose either local staged files or remote URLs. Keep
