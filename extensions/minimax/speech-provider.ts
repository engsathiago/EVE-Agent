...
import { asFiniteNumberInRange } from "eve-agent/plugin-sdk/string-coerce-runtime";
import {
...
function resolveConfiguredPortalTtsBaseUrl(cfg: EVEConfig | undefined): string | undefined {
