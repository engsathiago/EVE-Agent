...
import { resolveApprovalRequestChannelAccountId } from "eve-agent/plugin-sdk/approval-native-runtime";
import type {
  ExecApprovalRequest,
  PluginApprovalRequest,
} from "eve-agent/plugin-sdk/approval-runtime";
import type { EVEConfig } from "eve-agent/plugin-sdk/config-contracts";
import type { TelegramExecApprovalConfig } from "eve-agent/plugin-sdk/config-contracts";
...
function resolveTelegramOwnerApprovers(cfg: EVEConfig): Array<string | number> {
