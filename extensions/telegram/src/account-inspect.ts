...
import { resolveAccountWithDefaultFallback } from "eve-agent/plugin-sdk/account-core";
import { tryReadSecretFileSync } from "eve-agent/plugin-sdk/channel-core";
import type { EVEConfig } from "eve-agent/plugin-sdk/config-contracts";
import type { TelegramAccountConfig } from "eve-agent/plugin-sdk/config-contracts";
import { resolveDefaultSecretProviderAlias } from "eve-agent/plugin-sdk/provider-auth";
...
import { coerceSecretRef } from "eve-agent/plugin-sdk/secret-input-runtime";
import { FsSafeError } from "eve-agent/plugin-sdk/security-runtime";
...
function inspectTokenValue(params: { cfg: EVEConfig; value: unknown }): {
  token: string;
...
function hasConfiguredTelegramAccounts(cfg: EVEConfig): boolean {
