...
function listConfiguredAccountIds(cfg: EVEConfig): string[] {
...
function listBoundAccountIds(cfg: EVEConfig, channelId: string): string[] {
  const ids = new Set<string>();
...
function resolveDefaultAgentBoundAccountId(cfg: EVEConfig, channelId: string): string | null {
...
function hasImplicitDefaultTelegramAccount(cfg: EVEConfig): boolean {
...
export function listTelegramAccountIds(cfg: EVEConfig): string[] {
...
export function resolveDefaultTelegramAccountSelection(cfg: EVEConfig): {
  accountId: string;
  accountIds: string[];
...
export function resolveDefaultTelegramAccountId(cfg: EVEConfig): string {
