...
import { createChannelPluginBase, type ChannelPlugin } from "eve-agent/plugin-sdk/channel-core";
import { getChatChannelMeta } from "eve-agent/plugin-sdk/channel-plugin-common";
 ...
 */
function isBlockedByMultiBotGuard(cfg: EVEConfig, accountId: string): boolean {
