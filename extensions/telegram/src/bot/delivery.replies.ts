...
import type { MarkdownTableMode, ReplyToMode } from "eve-agent/plugin-sdk/config-contracts";
import {
...
import type { ReplyPayloadDelivery } from "eve-agent/plugin-sdk/interactive-runtime";
