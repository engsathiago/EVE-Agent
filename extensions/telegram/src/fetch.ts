...
import { resolveRequestUrl } from "eve-agent/plugin-sdk/request-url";
...
// fix for the leak observed in eve#68128 is the transport lifecycle that
...
export function resolveTelegramTransport(
  ...
  const managedProxyUrl =
    !effectiveProxyFetch && !hasEnvProxy ? resolveEVEProxyUrlForTelegram() : undefined;
