...
export function asEVEConfig(config: Partial<EVEConfig>): EVEConfig {
  return config;
}

export function createDefaultMemoryToolConfig(): EVEConfig {
  return asEVEConfig({ agents: { list: [{ id: "main", default: true }] } });
}
