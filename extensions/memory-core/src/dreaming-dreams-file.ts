...
import { replaceManagedMarkdownBlock } from "eve-agent/plugin-sdk/memory-host-markdown";
import { readRegularFile, replaceFileAtomic } from "eve-agent/plugin-sdk/security-runtime";

const DREAMS_FILENAMES = ["DREAMS.md", "dreams.md"] as const;
const DEEP_START_MARKER = "<!-- eve:dreaming:deep:start -->";
const DEEP_END_MARKER = "<!-- eve:dreaming:deep:end -->";
