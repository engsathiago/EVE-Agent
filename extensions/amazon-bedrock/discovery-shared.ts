 ...
 */
import { resolveAwsSdkEnvVarName } from "eve-agent/plugin-sdk/provider-auth-runtime";
import type { ModelProviderConfig } from "eve-agent/plugin-sdk/provider-model-shared";

/** Resolve the config auth marker that tells EVE to use AWS SDK credentials. */
