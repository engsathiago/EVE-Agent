...
import { createDangerousNameMatchingMutableAllowlistWarningCollector } from "eve-agent/plugin-sdk/channel-policy";
...
function collectSlackNameKeyedChannelWarnings({ cfg }: { cfg: EVEConfig }): string[] {
