...
describe("buildSlackProgressDraftBlocks", () => {
  ...
  it("uses configured max line chars for legacy rich draft details", () => {
      ...
      lines: [
        {
          ...
          icon: "🛠️",
          label: "Exec",
          detail: "run tests in /Users/example/Projects/eve/packages/very/deep/path/example",
          text: "🛠️ Exec: run tests in /Users/example/Projects/eve/packages/very/deep/path/example",
        },
      ],
    });
    ...
    expectLegacyLineBlock(
      blocks?.[1],
      "🛠️ *Exec*",
      "run tests in /Users/example/P…ve/packages/very/deep/path/example",
    );
  });
...
describe("native Slack progress stream chunks", () => {
  ...
  it("uses configured max line chars for native task details", () => {
    expect(
      ...
      taskUpdate(
        "tool_1",
        "Exec — run tests in /Users/example/P…ve/packages/very/deep/path/example",
        "in_progress",
      ),
    ]);
  });
