...
import type { EVEPluginApi } from "eve-agent/plugin-sdk/channel-plugin-common";
...
function resolveSlackWebhookPaths(config: EVEPluginApi["config"]): string[] {
...
export function registerSlackPluginHttpRoutes(api: EVEPluginApi): void {
