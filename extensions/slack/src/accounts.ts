...
export function mergeSlackAccountConfig(cfg: EVEConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: EVEConfig): ResolvedSlackAccount[] {
