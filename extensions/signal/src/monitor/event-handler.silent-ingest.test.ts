...
vi.mock("eve-agent/plugin-sdk/hook-runtime", async () => {
  const actual = await vi.importActual<typeof import("eve-agent/plugin-sdk/hook-runtime")>(
    "eve-agent/plugin-sdk/hook-runtime",
  );
  return {
    ...actual,
