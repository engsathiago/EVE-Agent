...
const mocks = vi.hoisted(() => ({
  ...
  ensureGatewayStartupAuth: vi.fn(async ({ cfg }: { cfg: EVEConfig }) => ({
    cfg: {
      ...cfg,
      gateway: {
        ...cfg.gateway,
...
function readPersistedConfig(): EVEConfig {
...
async function expectUnresolvedBrowserSecretRefSkipsPersistence(cfg: EVEConfig) {
