...
/** Mocks a launched EVE Chrome process with the supplied pid. */
export function mockLaunchedChrome(
  launchEVEChrome: { mockResolvedValue: (value: RunningChrome) => unknown },
  pid: number,
) {
  const proc = new EventEmitter() as unknown as ChildProcessWithoutNullStreams;
  launchEVEChrome.mockResolvedValue({
    pid,
