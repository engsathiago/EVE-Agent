...
type LitellmProviderConfig = NonNullable<NonNullable<EVEConfig["models"]>["providers"]>[string];
...
function resolveConfiguredLitellmBaseUrl(cfg: EVEConfig | undefined): string {
