...
import { coerceSecretRef } from "eve-agent/plugin-sdk/secret-ref-runtime";
...
export const secretTargetRegistryEntries: import("eve-agent/plugin-sdk/channel-secret-basic-runtime").SecretTargetRegistryEntry[] =
  [
    {
