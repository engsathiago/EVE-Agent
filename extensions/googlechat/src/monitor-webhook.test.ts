...
import type { FixedWindowRateLimiter } from "eve-agent/plugin-sdk/webhook-ingress";
...
vi.mock("eve-agent/plugin-sdk/webhook-request-guards", () => ({
  readJsonWebhookBodyOrReject,
}));

vi.mock("eve-agent/plugin-sdk/webhook-targets", () => ({
...
describe("googlechat monitor webhook", () => {
  ...
  afterAll(() => {
    vi.doUnmock("eve-agent/plugin-sdk/webhook-request-guards");
    vi.doUnmock("eve-agent/plugin-sdk/webhook-targets");
    vi.doUnmock("./auth.js");
    vi.resetModules();
  });
