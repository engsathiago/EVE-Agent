...
function resolveQianfanPreset(cfg: EVEConfig): {
  api: ModelApi;
  baseUrl: string;
...
export function applyQianfanProviderConfig(cfg: EVEConfig): EVEConfig {
  return qianfanPresetAppliers.applyProviderConfig(cfg);
}

export function applyQianfanConfig(cfg: EVEConfig): EVEConfig {
