// Xiaomi plugin entrypoint registers its EVE integration.
...
import {
  ...
  validateApiKeyInput,
} from "eve-agent/plugin-sdk/provider-auth-api-key";
import {
  applyModelCompatPatch,
  buildProviderReplayFamilyHooks,
} from "eve-agent/plugin-sdk/provider-model-shared";
import { PROVIDER_LABELS } from "eve-agent/plugin-sdk/provider-usage";
import {
  applyXiaomiConfig,
...
async function runXiaomiApiKeyAuth(
  ...
  params: {
    ...
    expectedKind: "payg" | "token-plan";
    defaultModel: string;
    applyConfig: (cfg: EVEConfig) => EVEConfig;
  },
