...
function getNostrConfig(cfg: EVEConfig): NostrAccountConfig | undefined {
  return (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
}

function listSetupNostrAccountIds(cfg: EVEConfig): string[] {
...
function resolveDefaultSetupNostrAccountId(cfg: EVEConfig): string {
