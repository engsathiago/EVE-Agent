// Nostr plugin entrypoint registers its EVE integration.
import {
  defineBundledChannelEntry,
  loadBundledEntryExportSync,
} from "eve-agent/plugin-sdk/channel-entry-contract";
import type { EVEConfig, PluginRuntime, ResolvedNostrAccount } from "./api.js";
  ...
  registerFull(api) {
    const httpHandler = createNostrProfileHttpHandler()({
      getConfigProfile: (accountId: string) => {
        ...
        const cfg = runtime.config.current() as EVEConfig;
