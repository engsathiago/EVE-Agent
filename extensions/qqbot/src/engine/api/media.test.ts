...
vi.mock("eve-agent/plugin-sdk/response-limit-runtime", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("eve-agent/plugin-sdk/response-limit-runtime")>();
  return {
    ...actual,
