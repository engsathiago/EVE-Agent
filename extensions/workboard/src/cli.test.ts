...
vi.mock("eve-agent/plugin-sdk/gateway-runtime", async () => {
  const actual = await vi.importActual<typeof import("eve-agent/plugin-sdk/gateway-runtime")>(
    "eve-agent/plugin-sdk/gateway-runtime",
  );
  return {
    ...actual,
