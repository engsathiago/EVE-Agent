...
vi.mock("eve-agent/plugin-sdk/config-mutation", () => ({
...
afterAll(() => {
  vi.doUnmock("eve-agent/plugin-sdk/runtime-config-snapshot");
  vi.doUnmock("eve-agent/plugin-sdk/config-mutation");
  vi.resetModules();
});
