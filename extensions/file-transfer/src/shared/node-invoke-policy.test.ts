...
import type { EVEPluginNodeInvokePolicyContext } from "eve-agent/plugin-sdk/plugin-entry";
...
function requireInvokeParams(
  invokeNode: ReturnType<typeof vi.fn<EVEPluginNodeInvokePolicyContext["invokeNode"]>>,
  callIndex: number,
) {
