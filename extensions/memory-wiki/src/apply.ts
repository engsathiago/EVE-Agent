...
const GENERATED_START = "<!-- eve:wiki:generated:start -->";
const GENERATED_END = "<!-- eve:wiki:generated:end -->";
const HUMAN_START = "<!-- eve:human:start -->";
const HUMAN_END = "<!-- eve:human:end -->";
