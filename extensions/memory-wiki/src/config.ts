...
import { buildPluginConfigSchema, z, type EVEPluginConfigSchema } from "../api.js";
...
export const memoryWikiConfigSchema: EVEPluginConfigSchema = memoryWikiConfigSchemaBase;
...
export function resolveDefaultMemoryWikiVaultPath(homedir = os.homedir()): string {
  return path.join(homedir, ".eve", "wiki", "main");
}
