...
export function applySyntheticProviderConfig(cfg: EVEConfig): EVEConfig {
  return syntheticPresetAppliers.applyProviderConfig(cfg);
}

export function applySyntheticConfig(cfg: EVEConfig): EVEConfig {
