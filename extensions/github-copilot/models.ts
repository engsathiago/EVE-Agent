...
import { buildCopilotIdeHeaders, COPILOT_INTEGRATION_ID } from "eve-agent/plugin-sdk/provider-auth";
import { readProviderJsonArrayFieldResponse } from "eve-agent/plugin-sdk/provider-http";
...
export function resolveCopilotForwardCompatModel(
  ...
  // by simply adding them to agents.defaults.models in eve.json — no
