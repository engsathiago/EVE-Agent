// EVE NPM Publish tests cover publish wrapper argument safety.
...
const scriptPath = "scripts/eve-npm-publish.sh";
...
describe("eve npm publish wrapper", () => {
  ...
  it("rejects extra publish arguments before npm publish", () => {
    const tempRoot = makeTempDir("eve-npm-publish-");
    const tarball = path.join(tempRoot, "eve.tgz");
