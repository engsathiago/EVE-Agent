...
export const ko: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "모바일에서 사용 중이신가요? 데스크톱에서 eve dashboard --no-open으로 전체 URL(#token=... 포함)을 복사하세요.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — eve models auth로 다시 인증하세요",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste: "eve dashboard --no-open의 토큰을 붙여넣거나 구성된 비밀번호를 입력하세요.",
        stepGenerate:
          "토큰이 구성되어 있지 않으면 Gateway 호스트에서 eve doctor --generate-gateway-token을 실행하세요.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "eve dashboard --no-open을 실행하고 새 URL을 열거나 해당 토큰을 붙여넣으세요.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Gateway 호스트에서 eve devices list를 실행하세요.",
        stepApproveId: "이 요청을 승인하세요: eve devices approve {requestId}.",
      ...
      network: {
        ...
        stepDashboard:
          "eve dashboard --no-open으로 dashboard를 다시 열어 현재 URL과 인증 세부 정보를 다시 복사하세요.",
      },
    },
  },
  chat: {
