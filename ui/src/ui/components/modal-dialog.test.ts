...
import type { EVEModalDialog } from "./modal-dialog.ts";
...
function expectShadowElement(modal: EVEModalDialog, id: string): HTMLElement {
...
describe("eve-modal-dialog", () => {
  ...
  it("opens a labelled modal dialog with an optional description", async () => {
    ...
    expect(labelId).toBe("eve-modal-dialog-label");
