...
export class EVEFilePreviewModal extends LitElement {
...
if (!customElements.get("eve-file-preview-modal")) {
  customElements.define("eve-file-preview-modal", EVEFilePreviewModal);
}
...
declare global {
  interface HTMLElementTagNameMap {
    "eve-file-preview-modal": EVEFilePreviewModal;
  }
}
