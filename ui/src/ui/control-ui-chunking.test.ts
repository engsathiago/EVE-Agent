...
describe("Control UI build chunking", () => {
  it("groups stable runtime dependencies into bounded chunks", () => {
    ...
    expect(controlUiManualChunk("/tmp/eve-pnpm-node-modules/json5/dist/index.js")).toBe(
      "config-runtime",
    );
    expect(controlUiManualChunk("/tmp/eve-pnpm-node-modules/@noble/ed25519/index.js")).toBe(
      "gateway-runtime",
    );
