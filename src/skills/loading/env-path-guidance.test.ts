...
const CASES: GuidanceCase[] = [
  {
    ...
    required: ["EVE_STATE_DIR"],
    forbidden: [
      "for f in ~/.eve/agents/<agentId>/sessions/*.jsonl",
      'rg -l "phrase" ~/.eve/agents/<agentId>/sessions/*.jsonl',
      "~/.eve/agents/<agentId>/sessions/<id>.jsonl",
    ],
  },
  {
    file: "skills/gh-issues/SKILL.md",
    required: ["EVE_CONFIG_PATH"],
    forbidden: ["cat ~/.eve/eve.json"],
  },
  {
  ...
  },
  {
    ...
    required: ["EVE_STATE_DIR"],
    forbidden: ["NEVER start Codex in ~/.eve/"],
  },
];
