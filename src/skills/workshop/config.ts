// Workshop config helpers resolve skill workshop settings from EVE config.
...
export function resolveSkillWorkshopConfig(config?: EVEConfig): SkillWorkshopConfig {
