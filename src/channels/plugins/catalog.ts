...
import type { EVEPackageManifest } from "../../plugins/manifest.js";
...
function resolveOfficialCatalogPaths(options: CatalogOptions): string[] {
  ...
  const packageRoots = uniqueStrings(
    [
      resolveEVEPackageRootSync({ cwd: process.cwd() }),
      resolveEVEPackageRootSync({ moduleUrl: import.meta.url }),
...
function toChannelMeta(params: {
  channel: NonNullable<EVEPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
