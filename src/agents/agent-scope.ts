...
function findMutableAgentEntry(cfg: EVEConfig, agentId: string): AgentConfig | undefined {
...
export function resolveAgentModelPrimary(cfg: EVEConfig, agentId: string): string | undefined {
