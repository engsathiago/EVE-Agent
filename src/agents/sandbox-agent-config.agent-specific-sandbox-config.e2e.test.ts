...
async function resolveContext(config: EVEConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): EVEConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
