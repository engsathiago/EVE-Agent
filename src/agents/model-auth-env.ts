...
import { normalizeProviderIdForAuth } from "@eve/model-catalog-core/provider-id";
import { normalizeOptionalString as normalizeOptionalPathInput } from "@eve/normalization-core/string-coerce";
