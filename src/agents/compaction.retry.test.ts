...
import * as agentSessions from "eve-agent/plugin-sdk/agent-sessions";
import type { AssistantMessage, UserMessage } from "eve-agent/plugin-sdk/llm";
import { afterEach, beforeEach, describe, expect, it, vi } from "vitest";
import { retryAsync } from "../infra/retry.js";

vi.mock("eve-agent/plugin-sdk/agent-sessions", async () => {
  const actual = await vi.importActual<typeof agentSessions>("eve-agent/plugin-sdk/agent-sessions");
  return {
    ...actual,
