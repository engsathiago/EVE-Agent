...
import {
  resolveEVEPluginToolInputs,
  type EVEPluginToolOptions,
} from "./eve-tools.plugin-context.js";
import { applyPluginToolDeliveryDefaults } from "./plugin-tool-delivery-defaults.js";
import type { AnyAgentTool } from "./tools/common.js";

type ResolveEVEPluginToolsOptions = EVEPluginToolOptions & {
...
export function resolveEVEPluginToolsForOptions(params: {
  options?: ResolveEVEPluginToolsOptions;
  resolvedConfig?: EVEConfig;
  ...
  const resolveApiKeyForProvider = authProfileStore
    ...
    : undefined;
  const pluginToolInputs = resolveEVEPluginToolInputs({
