/**
 * Runtime context resolver for EVE plugin tools.
 *
...
/** Options provided by agent runtime callers when invoking EVE plugin tools. */
...
export function resolveEVEPluginToolInputs(params: {
  options?: EVEPluginToolOptions;
