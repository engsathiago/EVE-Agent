...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  ...
  const base = {
    ...
    workspaceDir: "/tmp/eve-sandbox",
    agentWorkspaceDir: "/tmp/eve-workspace",
    workspaceAccess: "none",
    runtimeId: "eve-sbx-test",
    runtimeLabel: "eve-sbx-test",
    containerName: "eve-sbx-test",
    ...
    browser: {
      ...
      containerName: "eve-sbx-browser-test",
    },
