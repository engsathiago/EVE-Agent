/**
 * Materializes selected EVE skills as a temporary Claude CLI plugin.
 */
...
const EVE_CLAUDE_PLUGIN_NAME = "eve-skills";
...
export async function prepareClaudeCliSkillsPlugin(params: {
  ...
  const manifest = {
    name: EVE_CLAUDE_PLUGIN_NAME,
    version: "0.0.0",
    description: "Session-scoped EVE skills selected for this agent run.",
    skills: "./skills",
  };
  await fs.writeFile(
