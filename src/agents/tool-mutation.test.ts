...
describe("tool mutation helpers", () => {
  ...
  it.each([
    ...
    ["exec", "gh search prs --repo eve/eve tool-mutation --json number,title,state"],
    ["bash", "gh pr view 123 --repo eve/eve --json title,state"],
  ...
  it.each([
    ...
    ["exec", "gh api --method POST repos/eve/eve/issues"],
