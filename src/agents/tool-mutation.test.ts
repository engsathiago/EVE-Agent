...
describe("tool mutation helpers", () => {
  ...
  it.each([
    ...
    ["exec", "gh search prs --repo engsathiago/eve-agent tool-mutation --json number,title,state"],
    ["bash", "gh pr view 123 --repo engsathiago/eve-agent --json title,state"],
  ...
  it.each([
    ...
    ["exec", "gh api --method POST repos/engsathiago/eve-agent/issues"],
