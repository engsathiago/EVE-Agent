...
function getPackageDir(): string {
  ...
  const envDir = process.env.EVE_PACKAGE_DIR;
  if (envDir) {
    if (envDir === "~") {
      return homedir();
    }
...
// =============================================================================
// App Config (from package.json eveConfig)
// =============================================================================
...
const eveConfigName: string | undefined = pkg.eveConfig?.name;
export const APP_NAME: string = eveConfigName || "eve";
export const CONFIG_DIR_NAME: string = pkg.eveConfig?.configDir || ".eve";
...
// =============================================================================
// User Config Paths (~/.eve/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.eve/agent/) */
