// Verifies createEVETools wires shared config and context into the TTS tool.
import { beforeEach, describe, expect, it, vi } from "vitest";
import type { EVEConfig } from "../config/types.eve.js";
import { testing, createEVETools } from "./eve-tools.js";
...
const mocks = vi.hoisted(() => {
  ...
  return {
    ...
    textToSpeech: vi.fn(async () => ({
      success: true,
      audioPath: "/tmp/eve/tts-config-test.opus",
      provider: "microsoft",
...
vi.mock("./eve-plugin-tools.js", () => ({
  resolveEVEPluginToolsForOptions: () => [],
}));

vi.mock("./eve-tools.nodes-workspace-guard.js", () => ({
...
describe("createEVETools TTS config wiring", () => {
  beforeEach(() => {
...
describe("createEVETools media generation session wiring", () => {
  beforeEach(() => {
    mocks.createImageGenerateToolOptions.mockClear();
    mocks.createMusicGenerateToolOptions.mockClear();
    mocks.createVideoGenerateToolOptions.mockClear();
...
describe("createEVETools session status route context wiring", () => {
  beforeEach(() => {
...
describe("createEVETools cron context wiring", () => {
  beforeEach(() => {
    mocks.createCronToolOptions.mockClear();
  });
