 ...
 * streamable-HTTP SDK transports with EVE auth, redirect, and logging rules.
 */
import {
  SSEClientTransport,
...
function attachStderrLogging(serverName: string, transport: EVEStdioClientTransport) {
