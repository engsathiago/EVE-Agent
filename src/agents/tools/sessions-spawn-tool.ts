...
// Keep the schema local to avoid a circular import through acp-spawn/eve-tools.
...
function resolveAcpUnavailableMessage(opts?: { sandboxed?: boolean; config?: EVEConfig }) {
