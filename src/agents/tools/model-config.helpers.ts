...
/** Resolves the configured default model ref, falling back to EVE defaults. */
export function resolveDefaultModelRef(cfg?: EVEConfig): { provider: string; model: string } {
  if (cfg) {
