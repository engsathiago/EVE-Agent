 ...
 * pairs directly into the provider payload, so EVE must normalize here.
 */
 ...
 *
 * EVE persists provider-specific reasoning metadata in `thinkingSignature`; if that metadata
