...
type SandboxRegistryTable = EVEStateKyselyDatabase["sandbox_registry_entries"];
type SandboxRegistryDatabase = Pick<EVEStateKyselyDatabase, "sandbox_registry_entries">;
