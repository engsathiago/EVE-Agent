...
export const DEFAULT_SANDBOX_IMAGE = "eve-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "eve-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "eve-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "eve-sandbox-common:bookworm-slim";
...
export const DEFAULT_SANDBOX_BROWSER_PREFIX = "eve-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "eve-sandbox-browser";
