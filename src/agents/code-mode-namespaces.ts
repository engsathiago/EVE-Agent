...
const CODE_MODE_NAMESPACE_TOOL_CALL = Symbol.for("eve.codeMode.namespaceToolCall");
...
const CODE_MODE_NAMESPACE_REGISTRY_KEY = Symbol.for("eve.codeMode.namespaces");
...
function normalizeRegistration(
  ...
  if (RESERVED_NAMESPACE_GLOBALS.has(globalName) || globalName.startsWith("__eve")) {
