...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("eve.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("eve.contextEngineRegistryState");
