...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by EVE from plugin manifests, install records, and config policy. Use `eve plugins registry --refresh`, `eve plugins install/update/uninstall`, or `eve plugins enable/disable` instead.";
...
export type InstalledPluginIndexRecord = {
  ...
  /**
   * Package-authored eve.install metadata. This describes catalog/package
