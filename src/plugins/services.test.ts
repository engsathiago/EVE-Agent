...
import type { EVEPluginService, EVEPluginServiceContext } from "./types.js";
...
function expectServiceLogger(ctx: EVEPluginServiceContext) {
...
function expectServiceContexts(
  contexts: EVEPluginServiceContext[],
  config: Parameters<typeof startPluginServices>[0]["config"],
) {
...
describe("startPluginServices", () => {
  ...
  it("starts services and stops them in reverse order", async () => {
    const starts: string[] = [];
    const stops: string[] = [];
    const contexts: EVEPluginServiceContext[] = [];
  ...
  it("grants internal diagnostics only to trusted diagnostics exporter services", async () => {
    ...
    const prometheusContexts: EVEPluginServiceContext[] = [];
    ...
    const officialDiagnosticsOtelContexts: EVEPluginServiceContext[] = [];
    ...
    const officialInstallContexts: EVEPluginServiceContext[] = [];
    ...
    const untrustedContexts: EVEPluginServiceContext[] = [];
    ...
    const spoofedContexts: EVEPluginServiceContext[] = [];
