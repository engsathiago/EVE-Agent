...
const loadEVEProviderIndex = vi.hoisted(() =>
  vi.fn<LoadEVEProviderIndex>(() => ({ version: 1, providers: {} })),
);
...
function vllmPluginWithPackageInstall(): InstalledPluginIndexRecord {
  return {
    pluginId: "vllm",
    origin: "global",
    manifestPath: "/Users/test/.eve/plugins/vllm/eve.plugin.json",
    manifestHash: "hash",
    rootDir: "/Users/test/.eve/plugins/vllm",
    enabled: true,
    startup: {
      sidecar: false,
      memory: false,
    ...
    compat: [],
    packageName: "@eve/vllm",
    packageInstall: {
      npm: {
        spec: "@eve/vllm-fork@1.0.0",
        packageName: "@eve/vllm-fork",
        selector: "1.0.0",
...
describe("provider install catalog", () => {
  beforeEach(() => {
    vi.clearAllMocks();
    loadEVEProviderIndex.mockReturnValue({ version: 1, providers: {} });
      ...
      plugins: [
        {
          pluginId: "openai",
          origin: "bundled",
          manifestPath: "/repo/extensions/openai/eve.plugin.json",
          manifestHash: "hash",
          ...
          compat: [],
          packageName: "@eve/openai",
          packageInstall: {
            defaultChoice: "npm",
            npm: {
              spec: "@eve/openai@1.2.3",
              packageName: "@eve/openai",
              selector: "1.2.3",
              selectorKind: "exact-version",
              exactVersion: true,
  ...
  it("preserves durable ClawHub install records for provider setup reinstall hints", () => {
    loadPluginRegistrySnapshot.mockReturnValue(
      registrySnapshot({
        installRecords: {
          vllm: {
            source: "clawhub",
            spec: "clawhub:eve/vllm@2026.5.2",
            integrity: "sha256-clawpack",
            clawhubPackage: "eve/vllm",
          },
        },
        plugins: [vllmPluginWithPackageInstall()],
      }),
    ...
    expect(resolveProviderInstallCatalogEntry("vllm")).toEqual({
      ...
      origin: "global",
      install: {
        clawhubSpec: "clawhub:eve/vllm@2026.5.2",
      ...
      plugins: [
        {
          ...
          origin: "global",
          manifestPath: "/Users/test/.eve/plugins/demo-provider/eve.plugin.json",
          manifestHash: "hash",
          rootDir: "/Users/test/.eve/plugins/demo-provider",
          enabled: true,
          startup: {
            sidecar: false,
            memory: false,
      ...
      plugins: [
        {
          pluginId: "demo-provider",
          origin: "workspace",
          manifestPath: "/repo/extensions/demo-provider/eve.plugin.json",
          manifestHash: "hash",
  ...
  it("surfaces provider-index install metadata when the provider plugin is not installed", () => {
    loadEVEProviderIndex.mockReturnValue({
      version: 1,
      providers: {
        moonshot: {
          id: "moonshot",
          ...
          plugin: {
            id: "moonshot",
            package: "@eve/plugin-moonshot",
            install: {
              npmSpec: "@eve/plugin-moonshot@1.2.3",
              defaultChoice: "npm",
    ...
    expect(resolveProviderInstallCatalogEntry("moonshot-api-key")).toEqual({
      ...
      installSource: {
        defaultChoice: "npm",
        npm: {
          spec: "@eve/plugin-moonshot@1.2.3",
          packageName: "@eve/plugin-moonshot",
          selector: "1.2.3",
          selectorKind: "exact-version",
          exactVersion: true,
          expectedIntegrity: "sha512-moonshot",
  ...
  it("surfaces provider-index ClawHub install metadata as the preferred source", () => {
      ...
      providers: {
        moonshot: {
          ...
          plugin: {
            ...
            package: "@eve/plugin-moonshot",
            install: {
              clawhubSpec: "clawhub:eve/moonshot@2026.5.2",
              npmSpec: "@eve/plugin-moonshot@2026.5.2",
              defaultChoice: "clawhub",
              expectedIntegrity: "sha512-moonshot",
            },
          },
    ...
    expect(resolveProviderInstallCatalogEntry("moonshot-api-key")).toEqual({
      ...
      installSource: {
        defaultChoice: "clawhub",
        clawhub: {
          spec: "clawhub:eve/moonshot@2026.5.2",
          packageName: "eve/moonshot",
          version: "2026.5.2",
          exactVersion: true,
        },
        npm: {
          spec: "@eve/plugin-moonshot@2026.5.2",
          packageName: "@eve/plugin-moonshot",
          selector: "2026.5.2",
          selectorKind: "exact-version",
          exactVersion: true,
      ...
      plugins: [
        {
          pluginId: "moonshot",
          origin: "bundled",
          manifestPath: "/repo/extensions/moonshot/eve.plugin.json",
          manifestHash: "hash",
  ...
  it("keeps missing provider-index entries visible when only some provider plugins are installed", () => {
    ...
    loadEVEProviderIndex.mockReturnValue({
      ...
      providers: {
        groq: {
          ...
          plugin: {
            id: "groq",
            package: "@eve/plugin-groq",
            install: {
              npmSpec: "@eve/plugin-groq@1.0.0",
              defaultChoice: "npm",
            },
          },
          authChoices: [
        ...
        vllm: {
          ...
          plugin: {
            id: "vllm",
            package: "@eve/plugin-vllm",
            install: {
              clawhubSpec: "clawhub:eve/vllm@2026.5.2",
              npmSpec: "@eve/plugin-vllm@2026.5.2",
              defaultChoice: "clawhub",
            },
          },
          authChoices: [
    ...
    expect(resolveProviderInstallCatalogEntry("vllm-server")).toEqual({
      ...
      installSource: {
        ...
        npm: {
          spec: "@eve/plugin-vllm@2026.5.2",
          packageName: "@eve/plugin-vllm",
          selector: "2026.5.2",
          selectorKind: "exact-version",
          exactVersion: true,
