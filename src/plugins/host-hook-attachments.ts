...
import { detectMime, FILE_TYPE_SNIFF_MAX_BYTES, normalizeMimeType } from "@eve/media-core/mime";
...
export async function sendPluginSessionAttachment(
  params: PluginSessionAttachmentParams & { config?: EVEConfig; origin?: PluginOrigin },
