...
import type { EVEPluginCliCommandDescriptor, PluginLogger } from "./types.js";
...
const PLUGIN_CLI_ENTRIES_CACHE_KEY = Symbol.for("eve.plugin-cli-registration-entries-cache");
...
export const loadValidatedConfigForPluginRegistration = async (): Promise<EVEConfig | null> => {
...
): Promise<EVEPluginCliCommandDescriptor[]> {
