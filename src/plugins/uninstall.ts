...
import { relinkEVEPeerDependenciesInManagedNpmRoot } from "./plugin-peer-link.js";
...
export function removePluginFromConfig(
  ...
  pluginId: string,
  opts?: { channelIds?: string[] },
): { config: EVEConfig; actions: Omit<UninstallActions, "directory"> } {
  ...
  const config: EVEConfig = {
    ...
    channels: channels as EVEConfig["channels"],
  };
