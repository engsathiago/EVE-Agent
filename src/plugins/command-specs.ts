...
import type { EVEPluginCommandDefinition } from "./types.js";
...
function resolvePluginTextName(command: EVEPluginCommandDefinition): string {
...
function serializePluginCommandSpec(
  cmd: EVEPluginCommandDefinition,
  provider?: string,
): {
  name: string;
  description: string;
