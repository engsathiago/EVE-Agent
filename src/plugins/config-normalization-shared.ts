...
import { normalizeArrayBackedTrimmedStringList } from "@eve/normalization-core/string-normalization";
...
export function hasExplicitPluginConfig(plugins?: EVEConfig["plugins"]): boolean {
  if (!plugins) {
    return false;
  }
