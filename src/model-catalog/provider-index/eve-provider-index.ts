// Bundled EVE provider index advertises pre-install provider metadata for model picker discovery.
import type { EVEProviderIndex } from "./types.js";

// EVE-owned preview metadata for providers whose plugins may not be
...
export const EVE_PROVIDER_INDEX = {
  version: 1,
  providers: {
    moonshot: {
      id: "moonshot",
