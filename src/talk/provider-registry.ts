...
function resolveRealtimeVoiceProviderEntries(cfg?: EVEConfig): RealtimeVoiceProviderPlugin[] {
 ...
 */
export function listRealtimeVoiceProviders(cfg?: EVEConfig): RealtimeVoiceProviderPlugin[] {
