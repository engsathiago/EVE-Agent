...
const EXPORT_TRAJECTORY_DOCS_URL = "https://docs.eve.ai/tools/trajectory";
...
function buildTrajectoryExportExecRequest(
  ...
  return {
    argv: buildCurrentEVECliArgv(args),
    command: buildCurrentEVECliCommand(args),
    displayCommand: ["eve", ...args].join(" "),
    encodedRequest,
    request,
  };
}
