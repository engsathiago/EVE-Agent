...
describe("resolveReplyToMode", () => {
  ...
  it("uses registered channel threading adapters for runtime reply-mode resolution", () => {
    ...
    expect(resolveReplyToMode({} as EVEConfig, "whatsapp", "work", "group")).toBe("first");
    expect(resolveReplyToMode({} as EVEConfig, "whatsapp", "default", "group")).toBe("all");
  });
