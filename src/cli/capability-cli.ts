...
import { detectMime, extensionForMime, normalizeMimeType } from "@eve/media-core/mime";
import {
...
const LOCAL_MODEL_RUN_SYSTEM_PROMPT = "You are a personal assistant running inside EVE.";
...
function getAuthProfileIdsForProvider(cfg: EVEConfig, providerId: string): string[] {
...
function pinRuntimeConfigSnapshot(config: EVEConfig): void {
