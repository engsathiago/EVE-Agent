...
function resolveFetchConfig(config: EVEConfig): Record<string, unknown> | undefined {
...
function resolveSearchConfig(config: EVEConfig): Record<string, unknown> | undefined {
...
function getCapabilityWebSearchAutoDetectTargets(config: EVEConfig): CommandSecretTargetScope {
...
function getCapabilityWebFetchAutoDetectTargets(config: EVEConfig): CommandSecretTargetScope {
  return getCapabilityWebProviderAutoDetectTargets({
    config,
...
function isScopedChannelSecretTargetEntry(params: {
  ...
  return (
    ...
    params.entry.configFile === "eve.json" &&
