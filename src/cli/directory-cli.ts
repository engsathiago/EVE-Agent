    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["eve directory self --channel slack", "Show the connected account identity."],
          [
            'eve directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["eve directory groups list --channel discord", "List available groups/channels."],
          [
            "eve directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.eve.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
