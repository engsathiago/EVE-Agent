...
function stubSlackPlugin(params: {
  resolveAccount: (cfg: EVEConfig, accountId: string | null | undefined) => unknown;
  inspectAccount?: (cfg: EVEConfig, accountId: string | null | undefined) => unknown;
  isConfigured?: (account: unknown, cfg: EVEConfig) => boolean;
}) {
...
function makeSlackHttpConfig(): EVEConfig {
  return {
    channels: {
      slack: {
        enabled: true,
