...
describe("resolveOutboundSessionRoute", () => {
  ...
  const perChannelPeerCfg = { session: { dmScope: "per-channel-peer" } } as EVEConfig;
  ...
  const perChannelPeerSessionCfg = { session: { dmScope: "per-channel-peer" } } as EVEConfig;
  ...
  it.each([
    ...
    },
    {
      ...
      expected: {
        sessionKey: "agent:main:eve-weixin:direct:wxid_abc123@im.wechat",
        from: "eve-weixin:wxid_abc123@im.wechat",
