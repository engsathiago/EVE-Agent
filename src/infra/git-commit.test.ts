...
async function makeTempDir(label: string): Promise<string> {
  return await tempDirs.make(`eve-${label}-`);
}
...
describe("git commit resolution", () => {
  ...
  it("does not walk out of the eve package into a host repo", async () => {
