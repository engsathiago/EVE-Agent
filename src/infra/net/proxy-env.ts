...
// adding EVE NO_PROXY CIDR/wildcard bypass checks.
 ...
 * - EVE extension: IPv4 CIDR and octet-wildcard entries
 ...
 * in provider HTTP helpers; see eve#64974 review thread on NO_PROXY
 * SSRF bypass.
 */
