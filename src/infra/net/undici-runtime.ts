...
// EVE HTTP/1, timeout, proxy TLS, and IP-safe proxy policies.
...
export const TEST_UNDICI_RUNTIME_DEPS_KEY = "__EVE_TEST_UNDICI_RUNTIME_DEPS__";
...
/** Creates a direct undici Agent with EVE's HTTP/1-only dispatcher policy. */
...
/**
 * Creates an EnvHttpProxyAgent with EVE proxy TLS, IP-safe proxy pools,
