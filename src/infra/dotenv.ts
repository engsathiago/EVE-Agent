...
const BLOCKED_WORKSPACE_DOTENV_KEYS = new Set([
  ...
  "EVE_OAUTH_DIR",
  "EVE_PINNED_PYTHON",
  "EVE_PINNED_WRITE_PYTHON",
  "EVE_PLUGIN_INSTALL_OVERRIDES",
...
const BLOCKED_WORKSPACE_DOTENV_PREFIXES = [
  ...
  "CLAWHUB_",
  "OPENAI_API_KEY_",
  // Workspace .env is untrusted; reserve the full EVE runtime namespace
  // for shell/global config so new EVE_* controls are fail-closed by default.
  "EVE_",
  "EVE_CLAWHUB_",
  "EVE_DISABLE_",
  "EVE_SKIP_",
