...
export function listBindings(cfg: EVEConfig): AgentRouteBinding[] {
  return listRouteBindings(cfg);
}

export function listBoundAccountIds(cfg: EVEConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: EVEConfig) {
