...
function listConfiguredChannelIds(cfg: EVEConfig): string[] {
...
function listConfiguredChannelAccountIds(cfg: EVEConfig, channelId: string): string[] {
  if (!hasRecord(cfg.channels)) {
    return [];
  }
...
export function collectChannelRouteTargets(cfg: EVEConfig): ChannelRouteTarget[] {
