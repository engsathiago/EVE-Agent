...
type PromptDefaultModelResult = { model?: string; config?: EVEConfig };
...
function resolveConfiguredModelRaw(cfg: EVEConfig): string {
  return resolveAgentModelPrimaryValue(cfg.agents?.defaults?.model) ?? "";
}

function resolveConfiguredModelKeys(cfg: EVEConfig): string[] {
