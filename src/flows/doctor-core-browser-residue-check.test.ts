...
const residue = {
  legacyProfileDir: "/tmp/eve-home/browser/clawd",
  legacyUserDataDir: "/tmp/eve-home/browser/clawd/user-data",
  canonicalUserDataDir: "/tmp/eve-home/browser/eve/user-data",
};
...
describe("browser clawd profile residue health check", () => {
  ...
  it("reports legacy clawd profile residue through doctor lint", async () => {
    ...
    const cfg: EVEConfig = { browser: { profiles: { eve: { color: "#FF4500" } } } };
    ...
    const findings = await check.detect({
      ...
      runtime: runtime(),
      cfg,
      configPath: "/tmp/eve-home/eve.json",
    });
