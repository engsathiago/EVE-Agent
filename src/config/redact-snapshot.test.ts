...
describe("redactConfigSnapshot", () => {
          ...
          plugins: [
            {
              ...
              manifestPath: "/private/plugin/root/eve.plugin.json",
            },
          ],
          diagnostics: [],
        },
  ...
  it("does not redact passwordFile path fields", () => {
    const snapshot = makeSnapshot({
      channels: {
        irc: {
          passwordFile: "/etc/eve/irc-password.txt",
          nickserv: {
            passwordFile: "/etc/eve/nickserv-password.txt",
    ...
    expect(irc.passwordFile).toBe("/etc/eve/irc-password.txt");
    expect(nickserv.passwordFile).toBe("/etc/eve/nickserv-password.txt");
