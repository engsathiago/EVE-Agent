...
export function projectConfigOntoRuntimeSourceSnapshot(config: EVEConfig): EVEConfig {
  ...
  return applyMergePatch(projectedSource, runtimePatch) as EVEConfig;
}
