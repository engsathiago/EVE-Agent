...
export type AgentDefaultsConfig = {
  ...
  /** Embedded EVE runner hardening and compatibility controls. */
  embeddedAgent?: {
    /**
     * How embedded EVE should trust workspace-local `.eve/settings.json`.
    ...
    /**
     * Embedded EVE execution contract:
...
export type AgentCompactionConfig = {
  ...
  /** Embedded EVE reserve tokens target before floor enforcement. */
  reserveTokens?: number;
  /** Embedded EVE keepRecentTokens budget used for cut-point selection. */
  keepRecentTokens?: number;
  /** Minimum reserve tokens enforced for embedded EVE compaction (0 disables the floor). */
