...
// Candidate scanning only sees eve.json; auth-profile-only surfaces are audited elsewhere.
...
/**
 * Concrete unsupported config value discovered from an eve.json-like object.
 */
...
/**
 * Finds configured eve.json values whose surfaces currently reject SecretRef objects.
 */
