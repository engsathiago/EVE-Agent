...
function toCandidate(
  ...
  defaults: NonNullable<EVEConfig["secrets"]>["defaults"] | undefined,
 ...
 */
export function migrateLegacySecretRefEnvMarkers(config: EVEConfig): {
  config: EVEConfig;
  changes: string[];
} {
  ...
  const next = structuredClone(config) as EVEConfig & Record<string, unknown>;
