...
function makeContext(sourceConfig: EVEConfig): ResolverContext {
...
function collectAcpxConfigAssignments(config: EVEConfig): ResolverContext {
...
function expectInactiveAcpxConfig(config: EVEConfig): void {
