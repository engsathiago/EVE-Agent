...
import { maxBytesForKind, type MediaKind } from "@eve/media-core/constants";
import type { EVEConfig } from "../config/types.eve.js";

const MB = 1024 * 1024;

/** Resolves the global generated-media byte cap from the user-facing MB config value. */
export function resolveConfiguredMediaMaxBytes(cfg?: EVEConfig): number | undefined {
...
export function resolveGeneratedMediaMaxBytes(cfg: EVEConfig | undefined, kind: MediaKind) {
