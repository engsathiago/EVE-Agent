...
export const en = {
  ...
  wizard: {
    ...
    gateway: {
      ...
      plaintextPasswordHint: "Stores the password directly in EVE config",
    ...
    migration: {
      ...
      complete: "Migration complete. Run `eve doctor` next.",
    ...
    remote: {
      ...
      insecureRemoteUrl:
        "Use wss:// for remote hosts, or ws://127.0.0.1/localhost via SSH tunnel. Break-glass: EVE_ALLOW_INSECURE_PRIVATE_WS=1 for trusted private networks.",
      ...
      plaintextPasswordHint: "Stores the password directly in EVE config",
      plaintextPasswordLabel: "Enter password now",
      plaintextTokenHint: "Stores the token directly in EVE config",
    ...
    security: {
      ...
      beta: "EVE is a hobby project and still in beta. Expect sharp edges.",
      confirm:
        "I understand this is personal-by-default and shared/multi-user use requires lock-down. Continue?",
      hardeningRequired:
        "If you're not comfortable with security hardening and access control, don't run EVE.",
      learnMore: "Learn more",
      notMultitenant: "EVE is not a hostile multi-tenant boundary by default.",
      personalAgent: "By default, EVE is a personal agent: one trusted operator boundary.",
    ...
    skills: {
      ...
      docsLine: "Docs: https://docs.eve.ai/skills",
      enterEnv: "Enter {env}",
    ...
    nextcloudTalk: {
      ...
      helpInstallCommand:
        '2) Run: ./occ talk:bot:install "EVE" "<shared-secret>" "<webhook-url>" --feature webhook --feature response --feature reaction',
    ...
    whatsapp: {
      ...
      ownerNumberNote: "We need the sender/owner number so EVE can allowlist you.",
      ...
      separatePhoneLabel: "Separate phone just for EVE",
    ...
    irc: {
      ...
      nextStatusCommand: "Command: eve channels status --probe",
    ...
    synologyChat: {
      ...
      incomingWebhookHelpReplies: "This is the URL EVE uses to send replies back to Chat.",
    ...
    signal: {
      ...
      multipleEntries: "Multiple entries: comma-separated.",
      nextLinkDevice: 'Link device with: signal-cli link -n "EVE"',
    ...
    twitch: {
      ...
      envPrompt: "Twitch env var EVE_TWITCH_ACCESS_TOKEN detected. Use env token?",
      ...
      helpEnvVars: "Env vars supported: EVE_TWITCH_ACCESS_TOKEN",
    ...
    channelsPrimer: {
      ...
      blurbs: {
        ...
        synologyChat: "Connect your Synology NAS Chat to EVE with full agent capabilities.",
    ...
    search: {
      ...
      configured: "configured",
      configureLaterHint: "Configure later with eve configure --section web",
      docsLine: "Docs: {url}",
    ...
    finalize: {
      ...
      controlUiDocs: "Docs: https://docs.eve.ai/web/control-ui",
      dashboardCopyPaste: "Copy/paste this URL in a browser on this machine to control EVE.",
      dashboardLinkWithToken: "Dashboard link (with token): {url}",
      dashboardOpened: "Opened in your browser. Keep that tab to control EVE.",
      ...
      gatewayTokenStored:
        "Stored in: $EVE_CONFIG_PATH (default: ~/.eve/eve.json) under gateway.auth.token, or in EVE_GATEWAY_TOKEN.",
      ...
      restart: "Restart",
      securityReminder:
        "Running agents on your computer is risky — harden your setup: https://docs.eve.ai/security",
      ...
      webDocs: "Docs: https://docs.eve.ai/tools/web",
      ...
      whatNow: 'What now: https://eve.ai/showcase ("What People Are Building").',
      whatNowTitle: "What now",
      workspaceBackupTitle: "Workspace backup",
      workspaceDocs: "Docs: https://docs.eve.ai/concepts/agent-workspace",
