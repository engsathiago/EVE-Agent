...
export function hasAmbiguousGatewayAuthModeConfig(cfg: EVEConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: EVEConfig): void {
