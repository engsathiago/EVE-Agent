...
export function didSharedGatewayAuthChange(prev: EVEConfig, next: EVEConfig): boolean {
...
}): Promise<{ path: string; config: EVEConfig; queueFollowUp: () => void }> {
