...
import { normalizeOptionalString as resolveOptionalStringParam } from "@eve/normalization-core/string-coerce";
import {
  ErrorCodes,
  errorShape,
...
function resolveAgentIdOrError(agentIdRaw: string, cfg: EVEConfig) {
