...
describe("resolvePinnedClientMetadata", () => {
  ...
  it.each([
    ["eve-ios", "iOS 26.5.0", "iOS 26.4.2", "iPhone"],
    ["eve-ios", "iPadOS 26.5.0", "iPadOS 26.4.2", "iPad"],
    ["eve-ios", "iPadOS 26.5.0", "iOS 26.4.2", "iPad"],
    ["eve-android", "Android 16", "Android 15", "Android"],
  ])(
