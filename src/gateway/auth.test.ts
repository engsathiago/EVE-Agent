...
describe("gateway auth", () => {
  ...
  it("resolves token/password from EVE gateway env vars", () => {
    const auth = resolveGatewayAuth({
      authConfig: {},
      env: {
        EVE_GATEWAY_TOKEN: "env-token",
        EVE_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides EVE_GATEWAY_PASSWORD", () => {
...
describe("trusted-proxy auth", () => {
  ...
  it.each([
    ...
    },
    {
      ...
      env: {
        EVE_GATEWAY_TOKEN: "shared-secret",
      } as NodeJS.ProcessEnv,
    },
