/**
 * Hook system for EVE agent events
 *
 ...
 */
const INTERNAL_HOOK_HANDLERS_KEY = Symbol.for("eve.internalHookHandlers");
...
const INTERNAL_HOOKS_ENABLED_KEY = Symbol.for("eve.internalHooksEnabled");
