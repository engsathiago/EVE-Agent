...
function resolveTranscriptsSourceProviderEntries(cfg?: EVEConfig): TranscriptSourceProvider[] {
...
export function listTranscriptSourceProviders(cfg?: EVEConfig): TranscriptSourceProvider[] {
