...
export const DISABLE_PLUGIN_REGISTRY_MIGRATION_ENV = "EVE_DISABLE_PLUGIN_REGISTRY_MIGRATION";
export const FORCE_PLUGIN_REGISTRY_MIGRATION_ENV = "EVE_FORCE_PLUGIN_REGISTRY_MIGRATION";
...
export type PluginRegistryInstallMigrationParams = LoadInstalledPluginIndexParams &
  InstalledPluginIndexStoreOptions & {
    ...
    readConfig?: () => Promise<EVEConfig> | EVEConfig;
  };
...
function listConfiguredChannelIds(config: EVEConfig): Set<string> {
...
function listConfiguredModelProviderIds(config: EVEConfig): Set<string> {
...
export async function migratePluginRegistryForInstall(
  ...
  const config = stripShippedPluginInstallConfigRecords(rawConfig) as EVEConfig;
