...
import { isEVEOrgNpmSpec, parseRegistryNpmSpec } from "../infra/npm-registry-spec.js";
...
function shouldFallbackClawHubToNpm(params: {
  ...
  // Only official EVE npm packages are safe fallback targets for ClawHub
...
function addPluginLoadPath(cfg: EVEConfig, pluginPath: string): EVEConfig {
