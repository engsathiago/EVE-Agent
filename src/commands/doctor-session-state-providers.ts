...
import { normalizeStringEntriesLower } from "@eve/normalization-core/string-normalization";
...
function resolveSessionAgentId(cfg: EVEConfig, sessionKey: string): string {
