...
describe("status-all format", () => {
  ...
  it("formats dashboard values consistently", () => {
    expect(formatStatusDashboardValue("https://eve.local")).toBe("https://eve.local");
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        dashboardValue: "https://eve.local",
        ...
        middleRows: [{ Item: "Security", Value: "Run: eve security audit --deep" }],
      ...
      { Item: "Dashboard", Value: "https://eve.local" },
      ...
      { Item: "Security", Value: "Run: eve security audit --deep" },
