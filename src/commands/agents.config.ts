// Agent config mutation and summary builders used by `eve agents` commands.
import {
...
function resolveAgentModel(cfg: EVEConfig, agentId: string) {
...
export function buildAgentSummaries(cfg: EVEConfig): AgentSummary[] {
