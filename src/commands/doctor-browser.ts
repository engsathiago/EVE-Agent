...
type BrowserDoctorSurface = {
  noteChromeMcpBrowserReadiness: (cfg: EVEConfig, deps?: BrowserDoctorDeps) => Promise<void>;
...
export async function noteChromeMcpBrowserReadiness(cfg: EVEConfig, deps?: BrowserDoctorDeps) {
  try {
