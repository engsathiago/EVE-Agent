...
function resolveEffectiveTrustConfig(cfg: EVEConfig, env?: NodeJS.ProcessEnv): EVEConfig {
...
function resolveTrustedCatalogExtraPaths(cfg: EVEConfig): string[] | undefined {
