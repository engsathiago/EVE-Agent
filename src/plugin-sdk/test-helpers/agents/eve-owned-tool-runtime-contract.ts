// EVE-owned tool runtime contract helpers mock agent tool runtimes in SDK tests.
...
export function installEVEOwnedToolHooks(params?: {
 ...
 * Pair with `installEVEOwnedToolHooks()` when a test asserts before/after hook behavior.
 */
...
export function resetEVEOwnedToolHooks(): void {
  resetGlobalHookRunner();
  resetPluginRuntimeStateForTest();
