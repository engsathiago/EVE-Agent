...
type EnsureAuthProfileStore =
  typeof import("eve-agent/plugin-sdk/provider-auth").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("eve-agent/plugin-sdk/provider-auth").listProfilesForProvider;
...
function installSharedAuthProfileStoreHooks(state: { authStore: AuthProfileStore }) {
  beforeEach(() => {
    vi.doMock("eve-agent/plugin-sdk/provider-auth", async () => {
