/**
 * @deprecated Use `eve-agent/plugin-sdk/channel-outbound` for outbound/message
 * lifecycle helpers and `eve-agent/plugin-sdk/channel-inbound` for inbound
...
/** @deprecated Use `hasFinalInboundReplyDispatch(...)` from `eve-agent/plugin-sdk/channel-inbound`. */
export { hasFinalChannelTurnDispatch } from "../channels/turn/dispatch-result.js";
/** @deprecated Use `hasVisibleInboundReplyDispatch(...)` from `eve-agent/plugin-sdk/channel-inbound`. */
export { hasVisibleChannelTurnDispatch } from "../channels/turn/dispatch-result.js";
/** @deprecated Use `resolveInboundReplyDispatchCounts(...)` from `eve-agent/plugin-sdk/channel-inbound`. */
export { resolveChannelTurnDispatchCounts } from "../channels/turn/dispatch-result.js";

/** @deprecated Use `createChannelMessageReplyPipeline(...)` from `eve-agent/plugin-sdk/channel-outbound`. */
...
/** @deprecated Use `buildInboundReplyDispatchBase(...)` from `eve-agent/plugin-sdk/channel-inbound`. */
export { buildChannelMessageReplyDispatchBase } from "./inbound-reply-dispatch.js";
/** @deprecated Use `dispatchChannelInboundReply(...)` or `runPreparedInboundReply(...)` from `eve-agent/plugin-sdk/channel-inbound`. */
...
/** @deprecated Use `deliverInboundReplyWithMessageSendContext(...)` from `eve-agent/plugin-sdk/channel-outbound`. */
