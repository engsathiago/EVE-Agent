...
export const DEFAULT_EVE_BROWSER_ENABLED = true;
...
export const DEFAULT_EVE_BROWSER_COLOR = "#FF4500";
/** Default EVE-managed browser profile name. */
export const DEFAULT_EVE_BROWSER_PROFILE_NAME = "eve";
/** Default browser profile selected when config omits a profile name. */
export const DEFAULT_BROWSER_DEFAULT_PROFILE_NAME = "eve";
...
export const DEFAULT_UPLOAD_DIR = path.join(resolvePreferredEVETmpDir(), "uploads");
