...
export type TestPluginApiInput = Partial<EVEPluginApi>;

/** Create a minimal plugin API object for plugin-sdk contract and unit tests. */
export function createTestPluginApi(api: TestPluginApiInput = {}): EVEPluginApi {
