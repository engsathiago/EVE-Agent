...
/** @deprecated Use EVEConfig instead */
export type { EVEConfig as ClawdbotConfig } from "../config/config.js";
/** @deprecated Use EVEConfig instead */
export type { EVEConfig as EVESchemaType } from "../config/config.js";
export type {
