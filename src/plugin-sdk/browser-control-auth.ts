// Browser control auth helpers resolve plugin browser credentials from EVE config.
...
type BrowserControlAuthSurface = {
  resolveBrowserControlAuth: (cfg?: EVEConfig, env?: NodeJS.ProcessEnv) => BrowserControlAuth;
