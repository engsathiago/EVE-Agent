...
const FACADE_LOADER_GLOBAL = "__eveTestLoadBundledPluginPublicSurfaceModuleSync";
...
describe("plugin-sdk facade loader", () => {
  it("honors trusted bundled plugin dir overrides under the package root", () => {
    const pluginId = nextTrustedPluginId("eve-facade-loader-override-");
    const overrideA = createBundledPluginFixture({
      pluginId,
      kind: "dist",
      prefix: "eve-facade-loader-a-",
      marker: "override-a",
    });
    const overrideB = createBundledPluginFixture({
      pluginId,
      kind: "dist-runtime",
      prefix: "eve-facade-loader-b-",
      marker: "override-b",
    });

    process.env.EVE_BUNDLED_PLUGINS_DIR = overrideA.bundledPluginsDir;
    ...
    process.env.EVE_BUNDLED_PLUGINS_DIR = overrideB.bundledPluginsDir;
  ...
  it("falls back to package source surfaces when an override dir lacks a bundled plugin", () => {
    const fixture = createPackageSourcePluginFixture({
      prefix: "eve-facade-loader-source-fallback-",
      marker: "source-fallback",
    });
    process.env.EVE_BUNDLED_PLUGINS_DIR = createTempDirSync("eve-facade-loader-empty-");
  ...
  it("shares loaded facade ids with facade-runtime", () => {
    const fixture = createBundledPluginFixture({
      prefix: "eve-facade-loader-ids-",
      marker: "identity-check",
    });
    process.env.EVE_BUNDLED_PLUGINS_DIR = fixture.bundledPluginsDir;
  ...
  it("uses native require for Windows dist facade loads", () => {
    const fixture = createBundledPluginFixture({
      prefix: "eve-facade-loader-windows-",
  ...
  it("breaks circular facade re-entry during module evaluation", () => {
    const fixture = createCircularPluginFixture("eve-facade-loader-circular-");
    process.env.EVE_BUNDLED_PLUGINS_DIR = fixture.bundledPluginsDir;
  ...
  it("clears the cache on load failure so retries re-execute", () => {
    const fixture = createThrowingPluginFixture("eve-facade-loader-throw-");
    process.env.EVE_BUNDLED_PLUGINS_DIR = fixture.bundledPluginsDir;
