...
import { normalizeText } from "@eve/acp-core/normalize-text";
...
export { normalizeText } from "@eve/acp-core/normalize-text";
...
export type ConfiguredAcpBindingSpec = {
  ...
  /** Owning EVE agent id (used for session identity/storage). */
  agentId: string;
