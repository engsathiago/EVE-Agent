...
import type { AcpRuntime, AcpRuntimeCapabilities } from "@eve/acp-core/runtime/types";
...
export type { AcpRuntime, EVEConfig, SessionAcpMeta };
...
export function installAcpSessionManagerTestLifecycle(): void {
  ...
  afterEach(() => {
    if (ORIGINAL_STATE_DIR === undefined) {
      ...
      setTestEnvValue("EVE_STATE_DIR", ORIGINAL_STATE_DIR);
    }
