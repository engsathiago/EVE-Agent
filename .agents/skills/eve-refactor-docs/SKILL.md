---
name: eve-refactor-docs
description: Refactor an existing EVE docs page with source-audited preservation, restructuring, and verification.
---
...
Use this skill when the user gives a target EVE docs page and asks to
rewrite, refactor, reorganize, split, shorten, or improve it.

This skill builds on `eve-docs`: use that skill for style, page types,
...
Read `../eve-docs/SKILL.md` first. Apply its page-type, style,
...
Before editing, decide the intended page type from `eve-docs`.
