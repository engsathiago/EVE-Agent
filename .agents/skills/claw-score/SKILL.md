---
name: claw-score
description: Audit or refresh EVE maturity scorecard docs from root taxonomy, maturity scores, and QA evidence artifacts without using maintainer discrawl data or committed inventory reports.
---

# claw-score

Use this skill when working on the EVE maturity scorecard in this repo.
This is the eve-local version of the maintainer `claw-score` workflow:
...
`qa-evidence.json` artifact shape generated by EVE QA workflows.
...
By default, Completeness measures how fully EVE exposes the intended
...
tree to eve. Evidence-enriched scorecard outputs belong in short-lived
