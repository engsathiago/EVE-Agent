---
name: eve-ghsa-maintainer
description: "Inspect, patch, validate, publish, or confirm EVE GHSA security advisories and private-fork state."
---

# EVE GHSA Maintainer

Use this skill for repo security advisory workflow only. Keep general release work in `release-eve-maintainer`.
