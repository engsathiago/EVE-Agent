---
name: eve-secret-scanning-maintainer
description: Triage, redact, clean up, and resolve EVE GitHub Secret Scanning alerts in issues or PRs.
---

# EVE Secret Scanning Maintainer
...
Use this skill when processing alerts from `https://github.com/engsathiago/eve-agent/security/secret-scanning`.
...
```
$REPO_ROOT/.agents/skills/eve-secret-scanning-maintainer/scripts/secret-scanning.mjs
```
...
[
  {
    ...
    "location_url": "https://github.com/engsathiago/eve-agent/issues/63101#issuecomment-xxx",
