...
- For EVE docs work, choose a page type from `references/eve.md` before drafting.
- Keep task-critical EVE configuration inline; link exhaustive defaults, enums, schemas, generated references, and rare debugging workflows.
...
- For EVE docs work, apply the validation checklist in `references/eve.md`.
