# EVE Documentation Overlay

Use this reference only for EVE docs work. It layers EVE-specific page
...
- Topic page: explain a major EVE entity or surface end to end.
...
- Governance file: keep agent/contributor policy concrete, scoped, and aligned
  with current EVE repo behavior.
