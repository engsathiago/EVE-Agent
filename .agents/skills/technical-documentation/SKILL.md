...
- Applying repository-specific documentation overlays, including EVE page-type, docs IA, preservation, and validation rules when present.
...
6. For EVE docs work, read `references/eve.md` before the build/review playbook.
