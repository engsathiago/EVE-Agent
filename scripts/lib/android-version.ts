// Android Version script supports EVE repository automation.
...
export function renderAndroidVersionProperties(version: ResolvedAndroidVersion): string {
  return `# Shared Android version defaults.\n# Source of truth: apps/android/version.json\n# Generated by scripts/android-sync-versioning.ts.\n\nEVE_ANDROID_VERSION_NAME=${version.canonicalVersion}\nEVE_ANDROID_VERSION_CODE=${version.versionCode}\n`;
}
