// EVE release ClawHub plan script supports release workflow routing.
...
export type EVEReleaseClawHubPlanArgs = {
  releaseTag: string;
...
export type EVEReleaseClawHubPlan = {
...
export type EVEReleaseClawHubRuntimeStateArgs = {
  repository: string;
...
export type EVEReleaseClawHubRuntimeState = {
  verifierArgs: string[];
  proofLines: {
    normal: string;
    bootstrap: string;
...
export function buildEVEReleaseClawHubRuntimeState(
  args: EVEReleaseClawHubRuntimeStateArgs,
): EVEReleaseClawHubRuntimeState {
...
export async function buildEVEReleaseClawHubPlan(
  args: EVEReleaseClawHubPlanArgs,
  options: {
    rootDir?: string;
    fetchImpl?: typeof fetch;
    registryBaseUrl?: string;
  } = {},
): Promise<EVEReleaseClawHubPlan> {
