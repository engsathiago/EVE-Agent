...
// Test Force script supports EVE repository automation.
...
function usage(): string {
  return [
    ...
    "",
    "Clears the configured EVE gateway port, then runs the local test suite.",
    "",
    "Options:",
