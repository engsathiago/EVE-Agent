...
show_usage() {
    cat << EOF
clawlog - EVE Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View EVE logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    EVE logs flow through the macOS unified log (subsystem: ai.eve).
