...
- EVE_IOS_VERSION = exact canonical iOS version
- EVE_MARKETING_VERSION = short iOS/App Store version
- EVE_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
EVE_IOS_VERSION = ${IOS_VERSION}
EVE_MARKETING_VERSION = ${MARKETING_VERSION}
EVE_BUILD_VERSION = ${BUILD_NUMBER}
EOF
