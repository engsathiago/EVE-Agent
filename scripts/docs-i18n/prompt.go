...
- Keep product names in English: EVE, Raspberry Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the EVE Gateway, use “Gateway 网关”.
