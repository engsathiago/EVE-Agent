...
const logLevel = process.env.EVE_BUILD_VERBOSE ? "info" : "warn";
const INEFFECTIVE_DYNAMIC_IMPORT_MARKER = "[INEFFECTIVE_DYNAMIC_IMPORT]";
const UNRESOLVED_IMPORT_RE = /\[UNRESOLVED_IMPORT\]/;
const ANSI_ESCAPE_RE = new RegExp(String.raw`\u001B\[[0-9;]*m`, "g");
const DEPENDENCY_PATH_MARKERS = ["node_modules/", "eve-pnpm-node-modules/"];
...
const PRESERVE_CLI_STARTUP_METADATA_ENV = "EVE_PRESERVE_CLI_STARTUP_METADATA";
...
export function tsdownBuildUsage() {
  return [
    ...
    "",
    "Builds EVE with tsdown and validates emitted import diagnostics.",
    "",
    "Options:",
...
export function resolveTsdownBuildInvocation(params = {}) {
  ...
  if (env.EVE_BUILD_ALL_NO_PNPM === "1") {
    return {
