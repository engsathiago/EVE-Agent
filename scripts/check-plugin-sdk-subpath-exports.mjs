...
async function main() {
  ...
  if (violations.length === 0) {
    console.log("OK: all referenced eve-agent/plugin-sdk/<subpath> imports are exported.");
    return;
  }

  console.error(
    "Rule: every referenced eve-agent/plugin-sdk/<subpath> must exist in the public package exports.",
  );
