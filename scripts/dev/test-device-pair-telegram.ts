// Test Device Pair Telegram script supports EVE repository automation.
...
import { loadEVEPlugins } from "../../src/plugins/loader.js";
...
type DevicePairTelegramDeps = {
  ...
  loadEVEPlugins: typeof loadEVEPlugins;
...
async function runDevicePairTelegram(
  ...
  deps.loadEVEPlugins({ config: cfg });
