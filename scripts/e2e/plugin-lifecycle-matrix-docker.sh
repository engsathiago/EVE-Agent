...
IMAGE_NAME="$(docker_e2e_resolve_image "eve-plugin-lifecycle-matrix-e2e" EVE_PLUGIN_LIFECYCLE_MATRIX_E2E_IMAGE)"
SKIP_BUILD="${EVE_PLUGIN_LIFECYCLE_MATRIX_E2E_SKIP_BUILD:-0}"
cleanup() {
...
append_positive_int_env EVE_PLUGIN_LIFECYCLE_PHASE_TIMEOUT_MS
append_positive_int_env EVE_PLUGIN_LIFECYCLE_TIMEOUT_KILL_GRACE_MS
append_positive_int_env EVE_PLUGIN_LIFECYCLE_METRIC_POLL_MS
append_positive_int_env EVE_PLUGIN_LIFECYCLE_MAX_RSS_KB
append_positive_int_env EVE_PLUGIN_LIFECYCLE_MAX_WALL_MS
append_positive_number_env EVE_PLUGIN_LIFECYCLE_MAX_CPU_CORE_RATIO

PACKAGE_TGZ="$(docker_e2e_prepare_package_tgz plugin-lifecycle-matrix "${EVE_CURRENT_PACKAGE_TGZ:-}")"
