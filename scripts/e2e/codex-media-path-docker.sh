...
IMAGE_NAME="$(docker_e2e_resolve_image "eve-codex-media-path-e2e" EVE_CODEX_MEDIA_PATH_E2E_IMAGE)"
PORT="$(docker_e2e_read_tcp_port_env EVE_CODEX_MEDIA_PATH_PORT 18790)"
TIMEOUT_SECONDS="$(docker_e2e_read_positive_int_env EVE_CODEX_MEDIA_PATH_TIMEOUT_SECONDS 180)"
