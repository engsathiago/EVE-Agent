...
IMAGE_NAME="$(docker_e2e_resolve_image "eve-commitments-safety-e2e" EVE_COMMITMENTS_SAFETY_E2E_IMAGE)"
CONTAINER_NAME="eve-commitments-safety-e2e-$$"
RUN_LOG="$(mktemp -t eve-commitments-safety-log.XXXXXX)"
