...
IMAGE_NAME="$(docker_e2e_resolve_image "eve-session-runtime-context-e2e" EVE_SESSION_RUNTIME_CONTEXT_E2E_IMAGE)"
CONTAINER_NAME="eve-session-runtime-context-e2e-$$"
RUN_LOG="$(mktemp -t eve-session-runtime-context-log.XXXXXX)"
