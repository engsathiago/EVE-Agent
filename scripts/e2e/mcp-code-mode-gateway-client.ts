// Mcp Code Mode Gateway Client script supports EVE repository automation.
...
async function main() {
  ...
  const model = process.env.EVE_MCP_CODE_MODE_MODEL?.trim() || "eve/main";
  assert(gatewayUrl, "missing GW_URL");
  assert(gatewayToken, "missing GW_TOKEN");
  assert(stateDir, "missing EVE_STATE_DIR");
