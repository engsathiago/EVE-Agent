...
IMAGE_NAME="$(docker_e2e_resolve_image "eve-release-typed-onboarding-e2e" EVE_RELEASE_TYPED_ONBOARDING_E2E_IMAGE)"
SKIP_BUILD="${EVE_RELEASE_TYPED_ONBOARDING_E2E_SKIP_BUILD:-0}"
run_log=""
cleanup() {
...
PACKAGE_TGZ="$(docker_e2e_prepare_package_tgz release-typed-onboarding "${EVE_CURRENT_PACKAGE_TGZ:-}")"
...
EVE_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 release-typed-onboarding empty)"
