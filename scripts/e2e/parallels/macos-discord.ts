// Macos Discord script supports EVE repository automation.
...
${this.input.guestNode} ${this.input.guestEVEEntry} config set channels.discord.token ${shellQuote(this.input.config.token)}
${this.input.guestNode} ${this.input.guestEVEEntry} config set channels.discord.enabled true
${this.input.guestNode} ${this.input.guestEVEEntry} config set channels.discord.groupPolicy allowlist
${this.input.guestNode} ${this.input.guestEVEEntry} config set channels.discord.guilds ${shellQuote(guilds)} --strict-json
${this.input.guestNode} ${this.input.guestEVEEntry} doctor --fix --yes --non-interactive
...
JS
${this.input.guestNode} ${this.input.guestEVEEntry} plugins enable discord
${this.input.guestNode} ${this.input.guestEVEEntry} gateway restart
${this.input.guestNode} ${this.input.guestEVEEntry} channels status --probe --json`);
  }
