...
const OUTPUT_MAX_BYTES = readPositiveIntEnv("EVE_E2E_PTY_OUTPUT_MAX_BYTES", 16 * 1024 * 1024);
const FORCE_KILL_MS = readPositiveIntEnv("EVE_E2E_PTY_FORCE_KILL_MS", 5_000);
