...
const pluginRecordSnapshot = () => {
  const config = readJson(evePath("eve.json"));
...
function evePath(...parts) {
  return path.join(home, ".eve", ...parts);
}
...
function seedInstallState() {
  writeJson(evePath("extensions", "lossless-claw", "package.json"), {
    name: "@example/lossless-claw",
    version: "0.9.0",
  });
  writeJson(process.env.EVE_CONFIG_PATH, { plugins: {} });
  writePluginInstallIndexForE2E({
    version: 1,
    warning: "DO NOT EDIT. This file is generated by EVE plugin registry commands.",
...
function isCorruptPluginDisabledAfterUpdate(evidence, pluginId) {
  ...
  return (
    ...
    message.includes("EVE will continue without it")
  );
}
