...
IMAGE_NAME="$(docker_e2e_resolve_image "eve-crestodian-first-run-e2e" EVE_CRESTODIAN_FIRST_RUN_E2E_IMAGE)"
CONTAINER_NAME="eve-crestodian-first-run-e2e-$$"
RUN_LOG="$(mktemp -t eve-crestodian-first-run-log.XXXXXX)"
...
EVE_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 crestodian-first-run empty)"
