---
summary: "Contributor guide for adding a new shared capability to the EVE plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for EVE core developers. If you are
...
Use this when EVE needs a new shared domain such as embeddings, image
