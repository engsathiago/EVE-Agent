---
summary: "EVE Amazon Bedrock Mantle provider plugin for OpenAI-compatible model routing."
read_when:
...
EVE Amazon Bedrock Mantle provider plugin for OpenAI-compatible model routing.

## Distribution

- Package: `@eve/amazon-bedrock-mantle-provider`
