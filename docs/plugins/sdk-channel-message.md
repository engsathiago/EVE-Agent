...
`eve-agent/plugin-sdk/channel-message` and
`eve-agent/plugin-sdk/channel-message-runtime` remain deprecated compatibility
subpaths for older plugins. New channel plugins should use
`eve-agent/plugin-sdk/channel-outbound` for message lifecycle, receipt, durable
