...
Zalo ships as a bundled plugin in current EVE releases, so normal packaged
...
- Install via CLI: `eve plugins install @eve/zalo`
- Pinned version: `eve plugins install @eve/zalo@2026.5.2`
- Or from a source checkout: `eve plugins install ./path/to/local/zalo-plugin`
...
This page reflects current EVE behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `eve pairing list zalo`
  - `eve pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in EVE.
...
- Example: `eve message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `eve channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `eve logs --follow`
