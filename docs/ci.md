...
| `blacksmith-6vcpu-macos-15`      | `macos-node` on `eve/eve`; forks fall back to `macos-15`                                                                                                                                                                  |
| `blacksmith-12vcpu-macos-26`     | `macos-swift` on `eve/eve`; forks fall back to `macos-26`                                                                                                                                                                 |
...
- `source=npm` accepts only `eve@beta`, `eve@latest`, or an exact EVE release version such as `eve@2026.4.27-beta.2`. Use this for published prerelease/stable acceptance.
