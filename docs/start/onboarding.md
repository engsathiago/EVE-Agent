---
summary: "First-run setup flow for EVE (macOS app)"
read_when:
...
- By default, EVE is a personal agent: one trusted operator boundary.
...
<Frame caption="Choose what permissions do you want to give EVE">
...
<Step title="CLI">
  ...
  The app can install the global `eve` CLI via npm, pnpm, or bun.
