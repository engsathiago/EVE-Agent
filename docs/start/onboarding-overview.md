---
summary: "Overview of EVE onboarding options and flows"
read_when:
...
EVE has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `eve onboard`                     | Launch the app            |
...
CLI command docs: [`eve onboard`](/cli/onboard)

## macOS app onboarding

Open the EVE app. The first-run wizard walks you through the same steps
