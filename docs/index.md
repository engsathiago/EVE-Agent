---
summary: "EVE is a multi-channel gateway for AI agents that runs on any OS."
read_when:
  - Introducing EVE to newcomers
title: "EVE"
---
...
<p align="center">
    <img
        src="/assets/eve-logo-text-dark.png"
        alt="EVE"
        width="500"
        class="dark:hidden"
    />
    <img
        src="/assets/eve-logo-text.png"
        alt="EVE"
        width="500"
...
<Columns>
  <Card title="Get Started" href="/start/getting-started" icon="rocket">
    Install EVE and bring up the Gateway in minutes.
  </Card>
  <Card title="Run Onboarding" href="/start/wizard" icon="sparkles">
    Guided setup with `eve onboard` and pairing flows.
  </Card>
...
EVE is a **self-hosted gateway** that connects your favorite chat apps and channel surfaces — built-in channels plus bundled or external channel plugins such as Discord, Google Chat, iMessage, Matrix, Microsoft Teams, Signal, Slack, Telegram, WhatsApp, Zalo, and more — to AI coding agents. You run a single Gateway process on your own machine (or a server), and it becomes the bridge between your messaging apps and an always-available AI assistant.
...
<p align="center">
  <img src="/whatsapp-eve.jpg" alt="EVE" width="420" />
</p>

## Configuration (optional)

Config lives at `~/.eve/eve.json`.

- If you **do nothing**, EVE uses the bundled EVE agent runtime with per-sender sessions.
