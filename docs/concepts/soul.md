---
summary: "Use SOUL.md to give your EVE agent an actual voice instead of generic assistant sludge"
read_when:
...
EVE injects it on normal sessions, so it has real weight. If your agent
...
Path fixed for EVE workspaces: use `SOUL.md`, not `http://SOUL.md`.
...
<CardGroup cols={2}>
  <Card title="Agent workspace" href="/concepts/agent-workspace" icon="folder-open">
    Workspace files EVE injects into model context.
  </Card>
  <Card title="System prompt" href="/concepts/system-prompt" icon="message-lines">
    How `SOUL.md` is composed into EVE and Codex runtime context.
  </Card>
