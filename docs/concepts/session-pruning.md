...
EVE also builds a separate idempotent replay view for sessions that
...
EVE auto-enables pruning for Anthropic profiles:
...
If you set explicit values, EVE does not override them.
