...
read_when:
  - Planning a broad EVE application modernization pass
...
modernization task. If adopting this guidance as a repo-local EVE skill,
create `.agents/skills/eve-frontend/SKILL.md` first, keep the frontmatter
