...
title: "Together AI"
read_when:
  - You want to use Together AI with EVE
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    eve onboard --auth-choice together-api-key
    ```
  </Step>
...
EVE ships this bundled Together catalog:
...
<AccordionGroup>
  <Accordion title="Environment note">
    ...
    gateway processes. Use `~/.eve/.env` or `env.shellEnv` config for
  ...
  <Accordion title="Troubleshooting">
    - Verify your key works: `eve models list --provider together`
