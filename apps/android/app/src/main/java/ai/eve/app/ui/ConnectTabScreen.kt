      ...
      Surface(
        ...
        Column(
          ...
          if (pairingRequired) {
            ...
            CommandBlock("eve devices list")
            CommandBlock("eve devices approve <requestId>")
          }
          Text("EVE Android ${eveAndroidVersionLabel()}", style = mobileCaption1, color = mobileTextSecondary)
          Button(
            onClick = {
    ...
    AnimatedVisibility(visible = advancedOpen) {
      Surface(
        ...
        Column(
          ...
          CommandBlock("eve qr --setup-code-only")
          CommandBlock("eve qr --json")
          Text(
...
private fun gatewayPairingInstruction(problem: GatewayConnectionProblem?): String =
  if (problem?.canAutoRetry == true) {
    "Approve this phone on the gateway. EVE will reconnect automatically."
  } else {
