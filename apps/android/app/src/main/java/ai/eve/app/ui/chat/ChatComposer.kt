...
import ai.eve.app.ui.mobileAccentBorderStrong
...
import ai.eve.app.ui.mobileHeadline
import ai.eve.app.ui.mobileSurface
import ai.eve.app.ui.mobileText
import ai.eve.app.ui.mobileTextSecondary
import ai.eve.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.eve.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.eve.app.ui.mobileFontFamily,
