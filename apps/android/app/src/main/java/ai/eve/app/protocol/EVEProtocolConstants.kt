...
/** Capability ids advertised by the Android node to the EVE gateway. */
enum class EVECapability(
  val rawValue: String,
) {
  Canvas("canvas"),
  Camera("camera"),
...
enum class EVECanvasA2UICommand(
  val rawValue: String,
) {
...
enum class EVENotificationsCommand(
  val rawValue: String,
) {
