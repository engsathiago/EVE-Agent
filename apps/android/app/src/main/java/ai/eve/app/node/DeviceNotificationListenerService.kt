...
import ai.eve.app.NotificationBurstLimiter
import ai.eve.app.SecurePrefs
import ai.eve.app.allowsPackage
import ai.eve.app.isWithinQuietHours
...
class DeviceNotificationListenerService : NotificationListenerService() {
  ...
  companion object {
    ...
    private fun recentPackagesPrefs(context: Context) = context.applicationContext.getSharedPreferences("eve.secure", Context.MODE_PRIVATE)
