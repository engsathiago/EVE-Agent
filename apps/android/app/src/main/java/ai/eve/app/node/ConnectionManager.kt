...
import ai.eve.app.gateway.GatewayClientInfo
import ai.eve.app.gateway.GatewayConnectOptions
import ai.eve.app.gateway.GatewayEndpoint
import ai.eve.app.gateway.GatewayTlsParams
...
class ConnectionManager(
  ...
  fun buildUserAgent(): String {
    ...
    return "EVEAndroid/$version (Android $releaseLabel; SDK ${Build.VERSION.SDK_INT})"
  }
  ...
  fun buildNodeConnectOptions(): GatewayConnectOptions =
    GatewayConnectOptions(
      ...
      client = buildClientInfo(clientId = "eve-android", clientMode = "node"),
  ...
  fun buildOperatorConnectOptions(): GatewayConnectOptions =
    GatewayConnectOptions(
      ...
      commands = emptyList(),
      permissions = emptyMap(),
      client = buildClientInfo(clientId = "eve-android", clientMode = "ui"),
      userAgent = buildUserAgent(),
    )
