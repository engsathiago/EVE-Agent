...
private val LocalEVEDarkTheme = staticCompositionLocalOf { true }
...
fun EVETheme(
  ...
  EVESystemBarAppearance(lightAppearance = !isDark)

  CompositionLocalProvider(
    LocalMobileColors provides mobileColors,
    LocalEVEDarkTheme provides isDark,
  ) {
...
@Composable
internal fun EVESystemBarAppearance(lightAppearance: Boolean) {
...
fun overlayContainerColor(): Color {
  ...
  val isDark = LocalEVEDarkTheme.current
