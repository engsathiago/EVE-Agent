...
import ai.eve.app.GatewayDeviceTokenSummary
import ai.eve.app.GatewayNodeApprovalState
import ai.eve.app.GatewayNodeSummary
import ai.eve.app.GatewayNodesDevicesSummary
import ai.eve.app.GatewayPairedDeviceSummary
import ai.eve.app.GatewayPendingDeviceSummary
...
private fun nodeSubtitle(node: GatewayNodeSummary): String {
  ...
  val version = node.version?.let { "EVE $it" }
