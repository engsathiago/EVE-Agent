...
public struct EVEChatThinkingLevelOption: Codable, Identifiable, Sendable, Hashable {
...
public struct EVEChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct EVEChatSessionsDefaults: Codable, Sendable {
    public let modelProvider: String?
    public let model: String?
    public let contextTokens: Int?
    public let thinkingLevels: [EVEChatThinkingLevelOption]?
    ...
    public init(
        ...
        model: String?,
        contextTokens: Int?,
        thinkingLevels: [EVEChatThinkingLevelOption]? = nil,
...
public struct EVEChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
    public var id: String {
        self.key
    }
...
public struct EVEChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: EVEChatSessionsDefaults?
    public let sessions: [EVEChatSessionEntry]
