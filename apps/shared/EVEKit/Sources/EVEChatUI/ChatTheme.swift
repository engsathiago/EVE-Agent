...
enum EVEPlatformImageFactory {
    static func image(_ image: EVEPlatformImage) -> Image {
        #if os(macOS)
        Image(nsImage: image)
        #else
        Image(uiImage: image)
