...
public typealias EVEPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias EVEPlatformImage = UIImage
#endif

public struct EVEChatUsageCost: Codable, Hashable, Sendable {
...
public struct EVEChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: EVEChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(EVEChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct EVEChatMessageContent: Codable, Hashable, Sendable {
...
public struct EVEChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [EVEChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: EVEChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [EVEChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: EVEChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        let decodedUsage = try container.decodeIfPresent(EVEChatUsage.self, forKey: .usage)
        ...
        if let decoded = try? container.decode([EVEChatMessageContent].self, forKey: .content) {
...
public struct EVEChatHistoryPayload: Codable, Sendable {
...
public struct EVESessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct EVESessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [EVESessionPreviewItem]
}

public struct EVESessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [EVESessionPreviewEntry]

    public init(ts: Int, previews: [EVESessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct EVEChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct EVEChatCreateSessionResponse: Codable, Sendable {
    public let ok: Bool?
    public let key: String
    public let sessionId: String?
}

public struct EVEChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct EVESessionMessageEventPayload: Codable, Sendable {
    public let sessionKey: String?
    public let agentId: String?
    public let message: EVEChatMessage?
...
public struct EVEAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct EVEChatPendingToolCall: Identifiable, Hashable, Sendable {
    public var id: String {
        self.toolCallId
    }
...
public struct EVEGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct EVEPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: EVEPlatformImage?
...
public struct EVEChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
