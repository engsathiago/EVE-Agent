...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: EVEProtocol.AnyCodable]?
    {
        ...
        return [
            "id": EVEProtocol.AnyCodable(identity.deviceId),
            "publicKey": EVEProtocol.AnyCodable(publicKey),
            "signature": EVEProtocol.AnyCodable(signature),
            "signedAt": EVEProtocol.AnyCodable(signedAtMs),
            "nonce": EVEProtocol.AnyCodable(nonce),
        ]
    }
}
