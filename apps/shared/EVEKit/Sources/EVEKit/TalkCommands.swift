...
public enum EVETalkCommand: String, Codable, Sendable {
...
public struct EVETalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct EVETalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
