...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.eve", category: "node.gateway")
    ...
    {
        let timeoutLogger = Logger(subsystem: "ai.eve", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: EVEProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
