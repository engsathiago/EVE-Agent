...
public enum EVECanvasA2UICommand: String, Codable, Sendable {
...
public struct EVECanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct EVECanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
