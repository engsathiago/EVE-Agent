...
private struct AttachmentProcessingTransport: EVEChatTransport {
    func requestHistory(sessionKey _: String) async throws -> EVEChatHistoryPayload {
...
final class ChatViewModelAttachmentTests: XCTestCase {
    func testImageAttachmentsAreProcessedBeforeStaging() async throws {
        ...
        let viewModel = await MainActor.run {
            EVEChatViewModel(sessionKey: "main", transport: AttachmentProcessingTransport())
        }
