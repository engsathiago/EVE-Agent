...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = EVEChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = EVEChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
