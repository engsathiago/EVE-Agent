...
@Suite struct GatewayErrorsTests {
    ...
    @Test func connectAuthErrorPreservesStructuredMetadata() {
        let error = GatewayConnectAuthError(
            ...
            actionCommand: "eve devices approve req-123",
            docsURLString: "https://docs.eve.ai/gateway/pairing",
        ...
        #expect(error.actionCommand == "eve devices approve req-123")
        #expect(error.docsURLString == "https://docs.eve.ai/gateway/pairing")
    ...
    @Test func pairingProblemUsesStructuredRequestMetadata() {
        ...
        #expect(problem?.actionCommand == "eve devices approve req-123")
    }
