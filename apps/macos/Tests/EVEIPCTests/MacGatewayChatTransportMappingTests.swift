...
struct MacGatewayChatTransportMappingTests {
    @Test func `snapshot maps to health`() {
        let snapshot = Snapshot(
            presence: [],
            health: EVEProtocol.AnyCodable(["ok": EVEProtocol.AnyCodable(false)]),
    ...
    @Test func `health event maps to health`() {
        let frame = EventFrame(
            type: "event",
            event: "health",
            payload: EVEProtocol.AnyCodable(["ok": EVEProtocol.AnyCodable(true)]),
            seq: 1,
            stateversion: nil)
    ...
    @Test func `chat event maps to chat`() {
        let payload = EVEProtocol.AnyCodable([
            "runId": EVEProtocol.AnyCodable("run-1"),
            "sessionKey": EVEProtocol.AnyCodable("main"),
            "state": EVEProtocol.AnyCodable("final"),
        ])
    ...
    @Test func `session message event maps to session message`() {
        let payload = EVEProtocol.AnyCodable([
            "sessionKey": EVEProtocol.AnyCodable("agent:main:main"),
            "messageId": EVEProtocol.AnyCodable("msg-1"),
            "messageSeq": EVEProtocol.AnyCodable(7),
            "message": EVEProtocol.AnyCodable([
                "role": EVEProtocol.AnyCodable("user"),
                "content": EVEProtocol.AnyCodable([
                    EVEProtocol.AnyCodable([
                        "type": EVEProtocol.AnyCodable("text"),
                        "text": EVEProtocol.AnyCodable("spoken transcript"),
                    ]),
                ]),
                "timestamp": EVEProtocol.AnyCodable(1234.5),
            ]),
        ])
    ...
    @Test func `unknown event maps to nil`() {
        let frame = EventFrame(
            type: "event",
            event: "unknown",
            payload: EVEProtocol.AnyCodable(["a": EVEProtocol.AnyCodable(1)]),
            seq: 1,
            stateversion: nil)
        let mapped = MacGatewayChatTransport.mapPushToTransportEvent(.event(frame))
        #expect(mapped == nil)
