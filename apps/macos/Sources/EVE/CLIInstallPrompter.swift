...
final class CLIInstallPrompter {
    ...
    private let logger = Logger(subsystem: "ai.eve", category: "cli.prompt")
    ...
    func checkAndPromptIfNeeded(reason: String) {
        ...
        let alert = NSAlert()
        alert.messageText = "Install EVE CLI?"
    ...
    private func openSettings(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .eveSelectSettingsTab, object: tab)
        }
    }
