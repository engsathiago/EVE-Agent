...
enum UIStrings {
    static let welcomeTitle = "Welcome to EVE"
}
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: EVEChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g eve-agent@\(version)"
    }
