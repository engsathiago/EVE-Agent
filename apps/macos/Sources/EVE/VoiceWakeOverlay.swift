...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.eve", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other EVE windows, but below the system’s pop-up menus.
