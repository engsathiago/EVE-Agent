...
enum SessionMenuPreviewLoader {
    private static let logger = Logger(subsystem: "ai.eve", category: "SessionPreview")
    ...
    private static func requestPreview(
        keys: [String],
        maxItems: Int) async throws -> EVESessionsPreviewPayload
    {
    ...
    private static func snapshot(
        from entry: EVESessionPreviewEntry,
    ...
    private static func cache(payload: EVESessionsPreviewPayload, maxItems: Int) async {
    ...
    private static func previewItems(
        from payload: EVEChatHistoryPayload,
        maxItems: Int) -> [SessionPreviewItem]
    {
        let boundedItems = self.normalizeMaxItems(maxItems)
        let raw: [EVEKit.AnyCodable] = payload.messages ?? []
    ...
    private static func decodeMessages(_ raw: [EVEKit.AnyCodable]) -> [EVEChatMessage] {
    ...
    private static func previewText(for message: EVEChatMessage) -> String? {
    ...
    private static func isToolCall(_ message: EVEChatMessage) -> Bool {
    ...
    private static func toolNames(for message: EVEChatMessage) -> [String] {
        var names: [String] = []
    ...
    private static func mediaSummary(for message: EVEChatMessage) -> String? {
