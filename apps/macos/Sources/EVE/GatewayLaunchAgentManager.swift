...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.eve", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".eve/disable-launchagent"
...
extension GatewayLaunchAgentManager {
        ...
        quiet: Bool) async -> CommandResult
    {
        ...
        #endif
        let command = CommandResolver.eveCommand(
            subcommand: "gateway",
