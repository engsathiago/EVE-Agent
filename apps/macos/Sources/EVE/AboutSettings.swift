...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/engsathiago/eve-agent") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/engsathiago/eve-agent")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://eve.ai")
            ...
            Text("© 2026 EVE Foundation — MIT License.")
                .font(.footnote)
                .foregroundStyle(.secondary)
                .padding(.top, 4)
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "EVEBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "EVEBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "EVEGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "EVEGitCommit") as? String) ??
            "unknown"
    }
