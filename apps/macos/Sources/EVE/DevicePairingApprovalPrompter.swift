...
final class DevicePairingApprovalPrompter {
    ...
    private let logger = Logger(subsystem: "ai.eve", category: "device-pairing")
    ...
    static func alertSummary(for req: PendingRequest) -> String {
        ...
        return "Approve \(subject) to control EVE. Only approve if this is yours; you can remove it later in Settings."
    }
    ...
    static func deviceName(for req: PendingRequest) -> String {
        ...
        return self.isMac(req.platform) ? "EVE Mac app" : "New device"
    }
