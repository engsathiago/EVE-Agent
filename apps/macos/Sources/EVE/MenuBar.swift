...
struct EVEApp: App {
    ...
    private static let logger = Logger(subsystem: "ai.eve", category: "app")
    ...
    var body: some Scene {
        ...
        Window("EVE Settings", id: SettingsWindowOpener.windowID) {
    ...
    private func applyStatusItemAppearance(paused _: Bool, sleeping _: Bool) {
        ...
        self.statusItem?.button?.toolTip = self.state.voiceWakeMeterActive
            ? "EVE - Voice Wake live meter active"
            : "EVE"
    }
...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private let webChatAutoLogger = Logger(subsystem: "ai.eve", category: "Chat")
