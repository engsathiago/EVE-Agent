---
name: healthcheck
description: "Audit/harden EVE hosts: SSH, firewall, updates, exposure, backups, disk encryption, gateway security."
---

# EVE host healthcheck
...
- Never claim EVE manages OS firewall, SSH, or updates.
...
- Add scheduled `eve security audit --deep`.
