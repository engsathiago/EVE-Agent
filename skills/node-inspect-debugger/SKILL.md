...
metadata: { "eve": { "emoji": "🪲", "requires": { "bins": ["node"] } } }
---
...
- EVE CLI path: `node --inspect-brk eve.mjs ...`
- EVE test path: `EVE_VITEST_MAX_WORKERS=1 node --inspect-brk scripts/run-vitest.mjs <file>`
