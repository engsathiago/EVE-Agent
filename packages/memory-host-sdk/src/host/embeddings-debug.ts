...
const debugEmbeddings = isTruthyEnvValue(process.env.EVE_DEBUG_MEMORY_EMBEDDINGS);

/** Write embedding debug metadata when EVE_DEBUG_MEMORY_EMBEDDINGS is enabled. */
